...
public class clip_plane_enableType2 extends com.jmex.xml.xml.Node {
	...
	public clip_plane_enableType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public SchemaNCName getparam() throws Exception 
 {
	...
	public GLES_MAX_CLIP_PLANES_index getindexValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			...
			return new GLES_MAX_CLIP_PLANES_index(getDomNodeValue(curNode));
	}
