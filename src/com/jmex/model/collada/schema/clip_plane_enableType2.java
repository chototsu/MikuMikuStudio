/**
 * clip_plane_enableType2.java This file was generated by XMLSpy 2006sp2
...
public class clip_plane_enableType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public clip_plane_enableType2(clip_plane_enableType2 node) {
        super(node);
    }

    public clip_plane_enableType2(org.w3c.dom.Node node) {
        super(node);
    }

    public clip_plane_enableType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public clip_plane_enableType2(com.jmex.model.collada.xml.Document doc,
    ...
    public GLES_MAX_CLIP_PLANES_index getindexValueAtCursor(
    ...
    public void addindex(GLES_MAX_CLIP_PLANES_index value) {
        if (value.isNull() == false) {
    ...
    public void addindex(String value) throws Exception {
        addindex(new GLES_MAX_CLIP_PLANES_index(value));
    }
