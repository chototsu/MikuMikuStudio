...
public class library_materialsType extends com.jmex.xml.xml.Node {

	public library_materialsType(library_materialsType node) {
		super(node);
	}

	public library_materialsType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_materialsType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_materialsType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "material" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "material", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new materialType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_materials");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public int getmaterialCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "material");
	}

	public boolean hasmaterial() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "material");
	}

	public materialType newmaterial() {
		return new materialType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "material"));
	}

	public materialType getmaterialAt(int index) throws Exception {
		return new materialType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "material", index));
	}

	public org.w3c.dom.Node getStartingmaterialCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "material" );
	}

	public org.w3c.dom.Node getAdvancedmaterialCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "material", curNode );
	}

	public materialType getmaterialValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new materialType(curNode);
	}

	public materialType getmaterial() throws Exception 
 {
		return getmaterialAt(0);
	}

	public void removematerialAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "material", index);
	}
	...
	public org.w3c.dom.Node addmaterial(materialType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "material", value);
	}

	public void insertmaterialAt(materialType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "material", index, value);
	}

	public void replacematerialAt(materialType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "material", index, value);
	}
