/**
 * library_materialsType.java This file was generated by XMLSpy 2006sp2
...
public class library_materialsType extends com.jmex.model.collada.xml.Node {
    ...
    public library_materialsType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "material"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "material", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getmaterialCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "material");
    }
    ...
    public materialType newmaterial() {
        return new materialType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "material"));
    }

    public materialType getmaterialAt(int index) throws Exception {
        return new materialType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "material",
                index)));
    }
    ...
    public materialType getmaterialValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new materialType(dereference(curNode));
    }
    ...
    public void addmaterial(materialType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "material", value);
    }
