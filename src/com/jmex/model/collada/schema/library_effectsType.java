...
public class library_effectsType extends com.jmex.xml.xml.Node {
	...
	public library_effectsType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "effect" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "effect", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_effects");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public int geteffectCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "effect");
	}

	public boolean haseffect() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "effect");
	}

	public effectType neweffect() {
		return new effectType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "effect"));
	}

	public effectType geteffectAt(int index) throws Exception {
		return new effectType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "effect", index));
	}

	public org.w3c.dom.Node getStartingeffectCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "effect" );
	}

	public org.w3c.dom.Node getAdvancedeffectCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "effect", curNode );
	}

	public effectType geteffectValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new effectType(curNode);
	}
	...
	public effectType geteffect() throws Exception 
 {
	...
	public void removeeffectAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "effect", index);
	}
	...
	public org.w3c.dom.Node addeffect(effectType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "effect", value);
	}

	public void inserteffectAt(effectType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "effect", index, value);
	}

	public void replaceeffectAt(effectType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "effect", index, value);
	}
