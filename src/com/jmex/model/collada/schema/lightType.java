/**
 * lightType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class lightType extends com.jmex.model.collada.xml.Node {
    ...
    public lightType(com.jmex.model.collada.xml.Document doc,
    ...
    public technique_commonType4 newtechnique_common() {
        return new technique_commonType4(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "technique_common"));
    }

    public technique_commonType4 gettechnique_commonAt(int index)
            throws Exception {
        return new technique_commonType4(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
    ...
    public technique_commonType4 gettechnique_commonValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new technique_commonType4(dereference(curNode));
    }
    ...
    public void addtechnique_common(technique_commonType4 value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
