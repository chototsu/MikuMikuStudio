...
public class lightType extends com.jmex.xml.xml.Node {
	...
	public lightType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public assetType getasset() throws Exception 
 {
	...
	public technique_commonType4 gettechnique_commonValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			...
			return new technique_commonType4(curNode);
	}
