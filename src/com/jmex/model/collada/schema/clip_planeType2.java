/**
 * clip_planeType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class clip_planeType2 extends com.jmex.model.collada.xml.Node {
    ...
    public clip_planeType2(com.jmex.model.collada.xml.Document doc,
    ...
    public bool4 getvalue2At(int index) throws Exception {
        return new bool4(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public bool4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addvalue2(bool4 value) {
