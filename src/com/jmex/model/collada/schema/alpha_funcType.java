/**
 * alpha_funcType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class alpha_funcType extends com.jmex.model.collada.xml.Node {
    ...
    public alpha_funcType(com.jmex.model.collada.xml.Document doc,
    ...
    public funcType newfunc() {
        return new funcType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "func"));
    }

    public funcType getfuncAt(int index) throws Exception {
        return new funcType(dereference(getDomChildAt(Element,
    ...
    public funcType getfuncValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new funcType(dereference(curNode));
    }
    ...
    public void addfunc(funcType value) {
    ...
    public valueType newvalue2() {
        return new valueType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "value"));
    }
    ...
    public valueType getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new valueType(dereference(curNode));
    }
    ...
    public void addvalue2(valueType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "value", value);
    }
