...
public class line_stippleType extends com.jmex.xml.xml.Node {
	...
	public line_stippleType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "line_stipple");
	}
	...
	public int22 getvalue2At(int index) throws Exception {
		return new int22(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
	}
	...
	public int22 getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
	...
	public int22 getvalue2() throws Exception 
 {
	...
	public org.w3c.dom.Node addvalue2(int22 value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addvalue2(String value) throws Exception {
		return addvalue2(new int22(value));
	}
