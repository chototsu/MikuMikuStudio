...
public class library_lightsType extends com.jmex.xml.xml.Node {

	public library_lightsType(library_lightsType node) {
		super(node);
	}

	public library_lightsType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_lightsType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_lightsType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "light" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "light", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new lightType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_lights");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getlightMinCount() {
		return 1;
	}

	public static int getlightMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getlightCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "light");
	}

	public boolean haslight() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "light");
	}

	public lightType newlight() {
		return new lightType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "light"));
	}

	public lightType getlightAt(int index) throws Exception {
		return new lightType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "light", index));
	}

	public org.w3c.dom.Node getStartinglightCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "light" );
	}

	public org.w3c.dom.Node getAdvancedlightCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "light", curNode );
	}

	public lightType getlightValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new lightType(curNode);
	}

	public lightType getlight() throws Exception 
 {
		return getlightAt(0);
	}

	public void removelightAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "light", index);
	}
	...
	public org.w3c.dom.Node addlight(lightType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "light", value);
	}

	public void insertlightAt(lightType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "light", index, value);
	}

	public void replacelightAt(lightType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "light", index, value);
	}
