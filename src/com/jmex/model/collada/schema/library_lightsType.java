/**
 * library_lightsType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class library_lightsType extends com.jmex.model.collada.xml.Node {
    ...
    public library_lightsType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "light"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "light", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getlightCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "light");
    }
    ...
    public lightType newlight() {
        return new lightType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "light"));
    }
    ...
    public org.w3c.dom.Node getAdvancedlightCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "light",
                curNode);
    ...
    public lightType getlightValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new lightType(dereference(curNode));
    }
    ...
    public void removelightAt(int index) {
        removeDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "light", index);
    }
    ...
    public void addlight(lightType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "light", value);
    }
