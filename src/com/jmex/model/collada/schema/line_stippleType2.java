/**
 * line_stippleType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class line_stippleType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public line_stippleType2(line_stippleType2 node) {
        super(node);
    }

    public line_stippleType2(org.w3c.dom.Node node) {
        super(node);
    }

    public line_stippleType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public line_stippleType2(com.jmex.model.collada.xml.Document doc,
    ...
    public int22 newvalue2() {
        return new int22();
    }

    public int22 getvalue2At(int index) throws Exception {
        return new int22(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public int22 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public int22 getvalue2() throws Exception {
    ...
    public void addvalue2(int22 value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new int22(value));
    }

    public void insertvalue2At(int22 value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new int22(value), index);
    }

    public void replacevalue2At(int22 value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new int22(value), index);
    }
