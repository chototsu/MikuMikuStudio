/**
 * cull_faceType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class cull_faceType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public cull_faceType2(cull_faceType2 node) {
        super(node);
    }

    public cull_faceType2(org.w3c.dom.Node node) {
        super(node);
    }

    public cull_faceType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public cull_faceType2(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_face_type newvalue2() {
        return new gl_face_type();
    }

    public gl_face_type getvalue2At(int index) throws Exception {
        return new gl_face_type(getDomNodeValue(dereference(getDomChildAt(
    ...
    public gl_face_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new gl_face_type(getDomNodeValue(dereference(curNode)));
    }

    public gl_face_type getvalue2() throws Exception {
    ...
    public void addvalue2(gl_face_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_face_type(value));
    }

    public void insertvalue2At(gl_face_type value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new gl_face_type(value), index);
    }

    public void replacevalue2At(gl_face_type value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new gl_face_type(value), index);
    }
