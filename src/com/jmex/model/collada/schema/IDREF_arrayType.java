...
public class IDREF_arrayType extends com.jmex.xml.xml.Node {

	public IDREF_arrayType(IDREF_arrayType node) {
		super(node);
	}

	public IDREF_arrayType(org.w3c.dom.Node node) {
		super(node);
	}

	public IDREF_arrayType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public IDREF_arrayType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "IDREF_array");
	}
