/**
 * rigid_constraintType.java This file was generated by XMLSpy 2006sp2
...
public class rigid_constraintType extends com.jmex.model.collada.xml.Node {
    ...
    public rigid_constraintType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                ...
                "ref_attachment"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "ref_attachment", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new ref_attachmentType(tmpNode).adjustPrefix();
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "attachment"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "attachment", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public ref_attachmentType newref_attachment() {
        return new ref_attachmentType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "ref_attachment"));
    }
    ...
    public ref_attachmentType getref_attachmentAt(int index) throws Exception {
        return new ref_attachmentType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "ref_attachment", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedref_attachmentCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "ref_attachment", curNode);
    }

    public ref_attachmentType getref_attachmentValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new ref_attachmentType(dereference(curNode));
    }
    ...
    public void removeref_attachment() {
        while (hasref_attachment())
            removeref_attachmentAt(0);
    }

    public void addref_attachment(ref_attachmentType value) {
    ...
    public int getattachmentCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "attachment");
    }
    ...
    public attachmentType newattachment() {
        return new attachmentType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "attachment"));
    }

    public attachmentType getattachmentAt(int index) throws Exception {
        return new attachmentType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "attachment",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedattachmentCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "attachment",
                curNode);
    ...
    public attachmentType getattachmentValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new attachmentType(dereference(curNode));
    }
    ...
    public void addattachment(attachmentType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "attachment", value);
    }
    ...
    public technique_commonType8 newtechnique_common() {
        return new technique_commonType8(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "technique_common"));
    }

    public technique_commonType8 gettechnique_commonAt(int index)
            throws Exception {
        return new technique_commonType8(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
    ...
    public technique_commonType8 gettechnique_commonValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new technique_commonType8(dereference(curNode));
    }
    ...
    public void addtechnique_common(technique_commonType8 value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
