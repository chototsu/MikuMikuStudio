/**
 * light_model_color_controlType.java
 *
...
public class light_model_color_controlType extends com.jmex.xml.xml.Node {

	public light_model_color_controlType(light_model_color_controlType node) {
		super(node);
	}

	public light_model_color_controlType(org.w3c.dom.Node node) {
		super(node);
	}

	public light_model_color_controlType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public light_model_color_controlType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "light_model_color_control");
	}
	...
	public gl_light_model_color_control_type newvalue2() {
		return new gl_light_model_color_control_type();
	}

	public gl_light_model_color_control_type getvalue2At(int index) throws Exception {
		return new gl_light_model_color_control_type(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
	}
	...
	public gl_light_model_color_control_type getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new gl_light_model_color_control_type(getDomNodeValue(curNode));
	}

	public gl_light_model_color_control_type getvalue2() throws Exception 
 {
	...
	public org.w3c.dom.Node addvalue2(gl_light_model_color_control_type value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addvalue2(String value) throws Exception {
		return addvalue2(new gl_light_model_color_control_type(value));
	}

	public void insertvalue2At(gl_light_model_color_control_type value, int index) {
	...
	public void insertvalue2At(String value, int index) throws Exception {
		insertvalue2At(new gl_light_model_color_control_type(value), index);
	}

	public void replacevalue2At(gl_light_model_color_control_type value, int index) {
	...
	public void replacevalue2At(String value, int index) throws Exception {
		replacevalue2At(new gl_light_model_color_control_type(value), index);
	}
