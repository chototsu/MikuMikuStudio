...
public class fx_sampler3D_common extends com.jmex.xml.xml.Node {

	public fx_sampler3D_common(fx_sampler3D_common node) {
		super(node);
	}

	public fx_sampler3D_common(org.w3c.dom.Node node) {
		super(node);
	}

	public fx_sampler3D_common(org.w3c.dom.Document doc) {
		super(doc);
	}

	public fx_sampler3D_common(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "fx_sampler3D_common");
	}
	...
	public fx_sampler_wrap_common getwrap_t() throws Exception 
 {
	...
	public int getwrap_pCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p");
	}

	public boolean haswrap_p() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p");
	}
	...
	public fx_sampler_wrap_common getwrap_pAt(int index) throws Exception {
		return new fx_sampler_wrap_common(getDomNodeValue(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", index)));
	}

	public org.w3c.dom.Node getStartingwrap_pCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p" );
	}

	public org.w3c.dom.Node getAdvancedwrap_pCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", curNode );
	}

	public fx_sampler_wrap_common getwrap_pValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new fx_sampler_wrap_common(getDomNodeValue(curNode));
	...
	public fx_sampler_wrap_common getwrap_p() throws Exception 
 {
	...
	public void removewrap_pAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", index);
	}
	...
	public org.w3c.dom.Node addwrap_p(fx_sampler_wrap_common value) {
		if( value.isNull() )
			return null;

		return  appendDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", value.toString());
	}

	public org.w3c.dom.Node addwrap_p(String value) throws Exception {
		return addwrap_p(new fx_sampler_wrap_common(value));
	}

	public void insertwrap_pAt(fx_sampler_wrap_common value, int index) {
		insertDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", index, value.toString());
	}
	...
	public void replacewrap_pAt(fx_sampler_wrap_common value, int index) {
		replaceDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "wrap_p", index, value.toString());
	}
