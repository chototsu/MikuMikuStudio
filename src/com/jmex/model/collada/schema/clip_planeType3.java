/**
 * clip_planeType3.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class clip_planeType3 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public clip_planeType3(clip_planeType3 node) {
        super(node);
    }

    public clip_planeType3(org.w3c.dom.Node node) {
        super(node);
    }

    public clip_planeType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public clip_planeType3(com.jmex.model.collada.xml.Document doc,
    ...
    public float4 getvalue2At(int index) throws Exception {
        return new float4(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public float4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addvalue2(float4 value) {
