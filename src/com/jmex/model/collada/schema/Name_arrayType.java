...
public class Name_arrayType extends com.jmex.xml.xml.Node {

	public Name_arrayType(Name_arrayType node) {
		super(node);
	}

	public Name_arrayType(org.w3c.dom.Node node) {
		super(node);
	}

	public Name_arrayType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public Name_arrayType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
		super(doc, namespaceURI, prefix, name);
	}
	

	public ListOfNames getValue() {
		return new ListOfNames(getDomNodeValue(domNode));
	}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "Name_array");
	}
