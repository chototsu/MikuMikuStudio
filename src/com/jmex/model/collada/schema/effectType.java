/**
 * effectType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class effectType extends com.jmex.model.collada.xml.Node {
    ...
    public effectType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLES"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "profile_GLES", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new profile_GLESType(tmpNode).adjustPrefix();
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "profile_COMMON"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "profile_COMMON", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new profile_COMMONType(tmpNode).adjustPrefix();
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_CG"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "profile_CG", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLSL"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "profile_GLSL", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public fx_newparam_common newnewparam() {
        return new fx_newparam_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "newparam"));
    }
    ...
    public fx_newparam_common getnewparamAt(int index) throws Exception {
        return new fx_newparam_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "newparam",
                index)));
    }
    ...
    public fx_newparam_common getnewparamValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_newparam_common(dereference(curNode));
    }
    ...
    public void addnewparam(fx_newparam_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "newparam", value);
    }
    ...
    public profile_GLESType newprofile_GLES() {
        return new profile_GLESType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLES"));
    }

    public profile_GLESType getprofile_GLESAt(int index) throws Exception {
        return new profile_GLESType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLES",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedprofile_GLESCursor(
    ...
    public profile_GLESType getprofile_GLESValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new profile_GLESType(dereference(curNode));
    }
    ...
    public void addprofile_GLES(profile_GLESType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "profile_GLES", value);
    }
    ...
    public profile_COMMONType newprofile_COMMON() {
        return new profile_COMMONType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "profile_COMMON"));
    }
    ...
    public profile_COMMONType getprofile_COMMONAt(int index) throws Exception {
        return new profile_COMMONType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "profile_COMMON", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedprofile_COMMONCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "profile_COMMON", curNode);
    }

    public profile_COMMONType getprofile_COMMONValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new profile_COMMONType(dereference(curNode));
    }
    ...
    public void addprofile_COMMON(profile_COMMONType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "profile_COMMON", value);
    }

    public void insertprofile_COMMONAt(profile_COMMONType value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "profile_COMMON", index, value);
    }
    ...
    public profile_CGType newprofile_CG() {
        return new profile_CGType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "profile_CG"));
    }

    public profile_CGType getprofile_CGAt(int index) throws Exception {
        return new profile_CGType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_CG",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedprofile_CGCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_CG",
                curNode);
    ...
    public profile_CGType getprofile_CGValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new profile_CGType(dereference(curNode));
    }
    ...
    public void addprofile_CG(profile_CGType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "profile_CG", value);
    }
    ...
    public profile_GLSLType newprofile_GLSL() {
        return new profile_GLSLType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLSL"));
    }

    public profile_GLSLType getprofile_GLSLAt(int index) throws Exception {
        return new profile_GLSLType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLSL",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedprofile_GLSLCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "profile_GLSL",
                curNode);
    ...
    public profile_GLSLType getprofile_GLSLValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new profile_GLSLType(dereference(curNode));
    }
    ...
    public void addprofile_GLSL(profile_GLSLType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "profile_GLSL", value);
    }
