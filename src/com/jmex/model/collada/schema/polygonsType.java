...
public class polygonsType extends com.jmex.xml.xml.Node {
	...
	public ListOfUInts getp() throws Exception 
 {
	...
	public int getphCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "ph");
	}

	public boolean hasph() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "ph");
	}

	public phType newph() {
		return new phType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "ph"));
	}

	public phType getphAt(int index) throws Exception {
		return new phType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "ph", index));
	}

	public org.w3c.dom.Node getStartingphCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "ph" );
	}

	public org.w3c.dom.Node getAdvancedphCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "ph", curNode );
	}
	...
	public phType getph() throws Exception 
 {
	...
	public void removephAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "ph", index);
	}
	...
	public org.w3c.dom.Node addph(phType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "ph", value);
	}

	public void insertphAt(phType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "ph", index, value);
	}

	public void replacephAt(phType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "ph", index, value);
	}
