...
public class allType2 extends com.jmex.xml.xml.Node {

	/**
     * 
     */
    private static final long serialVersionUID = -8554469965670227567L;

    public allType2(allType2 node) {
		super(node);
	}

	public allType2(org.w3c.dom.Node node) {
		super(node);
	}

	public allType2(org.w3c.dom.Document doc) {
		super(doc);
	}

	public allType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
