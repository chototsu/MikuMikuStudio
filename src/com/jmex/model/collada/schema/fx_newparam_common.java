/**
 * fx_newparam_common.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class fx_newparam_common extends com.jmex.model.collada.xml.Node {
    ...
    public fx_newparam_common(com.jmex.model.collada.xml.Document doc,
    ...
    public fx_sampler1D_common newsampler1D() {
        return new fx_sampler1D_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "sampler1D"));
    }
    ...
    public fx_sampler1D_common getsampler1DAt(int index) throws Exception {
        return new fx_sampler1D_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "sampler1D",
                index)));
    }
    ...
    public fx_sampler1D_common getsampler1DValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_sampler1D_common(dereference(curNode));
    }
    ...
    public void addsampler1D(fx_sampler1D_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "sampler1D", value);
    }
    ...
    public fx_sampler2D_common newsampler2D() {
        return new fx_sampler2D_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "sampler2D"));
    }
    ...
    public fx_sampler2D_common getsampler2DAt(int index) throws Exception {
        return new fx_sampler2D_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "sampler2D",
                index)));
    }
    ...
    public fx_sampler2D_common getsampler2DValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_sampler2D_common(dereference(curNode));
    }
    ...
    public void addsampler2D(fx_sampler2D_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "sampler2D", value);
    }
    ...
    public fx_sampler3D_common newsampler3D() {
        return new fx_sampler3D_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "sampler3D"));
    }
    ...
    public fx_sampler3D_common getsampler3DAt(int index) throws Exception {
        return new fx_sampler3D_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "sampler3D",
                index)));
    }
    ...
    public fx_sampler3D_common getsampler3DValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_sampler3D_common(dereference(curNode));
    }
    ...
    public void addsampler3D(fx_sampler3D_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "sampler3D", value);
    }
    ...
    public fx_samplerCUBE_common newsamplerCUBE() {
        return new fx_samplerCUBE_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "samplerCUBE"));
    }
    ...
    public fx_samplerCUBE_common getsamplerCUBEAt(int index) throws Exception {
        return new fx_samplerCUBE_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "samplerCUBE",
                index)));
    }
    ...
    public fx_samplerCUBE_common getsamplerCUBEValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_samplerCUBE_common(dereference(curNode));
    }
    ...
    public void addsamplerCUBE(fx_samplerCUBE_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "samplerCUBE", value);
    }
    ...
    public fx_samplerRECT_common newsamplerRECT() {
        return new fx_samplerRECT_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "samplerRECT"));
    }
    ...
    public fx_samplerRECT_common getsamplerRECTAt(int index) throws Exception {
        return new fx_samplerRECT_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "samplerRECT",
                index)));
    }
    ...
    public fx_samplerRECT_common getsamplerRECTValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_samplerRECT_common(dereference(curNode));
    }
    ...
    public void addsamplerRECT(fx_samplerRECT_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "samplerRECT", value);
    }
    ...
    public fx_samplerDEPTH_common newsamplerDEPTH() {
        return new fx_samplerDEPTH_common(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "samplerDEPTH"));
    }
    ...
    public fx_samplerDEPTH_common getsamplerDEPTHAt(int index) throws Exception {
        return new fx_samplerDEPTH_common(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "samplerDEPTH",
                index)));
    }
    ...
    public fx_samplerDEPTH_common getsamplerDEPTHValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new fx_samplerDEPTH_common(dereference(curNode));
    }
    ...
    public void addsamplerDEPTH(fx_samplerDEPTH_common value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "samplerDEPTH", value);
    }
    ...
    public SchemaString getenumValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addenum(SchemaString value) {
        if (value.isNull() == false) {
            appendDomChild(Element,
                    "http://www.collada.org/2005/11/COLLADASchema", "enum",
                    value.toString());
    ...
    public void addenum(String value) throws Exception {
        addenum(new SchemaString(value));
    }
