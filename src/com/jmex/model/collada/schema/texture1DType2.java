/**
 * texture1DType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class texture1DType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public texture1DType2(texture1DType2 node) {
        super(node);
    }

    public texture1DType2(org.w3c.dom.Node node) {
        super(node);
    }

    public texture1DType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public texture1DType2(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_sampler1D newvalue2() {
        return new gl_sampler1D(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "value"));
    }

    public gl_sampler1D getvalue2At(int index) throws Exception {
        return new gl_sampler1D(
    ...
    public gl_sampler1D getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public gl_sampler1D getvalue2() throws Exception {
    ...
    public void addvalue2(gl_sampler1D value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "value", value);
    }

    public void insertvalue2At(gl_sampler1D value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "value", index, value);
    }

    public void replacevalue2At(gl_sampler1D value, int index) {
