/**
 * imageType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class imageType extends com.jmex.model.collada.xml.Node {
    ...
    public imageType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "format"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "format", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "height"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "height", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "width"); tmpNode != null; tmpNode = getDomNextChild(Attribute,
                null, "width", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "depth"); tmpNode != null; tmpNode = getDomNextChild(Attribute,
                null, "depth", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "data"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "data", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        }
    ...
    public SchemaToken getformatAt(int index) throws Exception {
        return new SchemaToken(getDomNodeValue(dereference(getDomChildAt(
                Attribute, null, "format", index))));
    }
    ...
    public SchemaToken getformatValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new SchemaToken(getDomNodeValue(dereference(curNode)));
    }
    ...
    public void addformat(SchemaToken value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "format", value.toString());
        }
    }

    public void addformat(String value) throws Exception {
        addformat(new SchemaToken(value));
    }
    ...
    public uint getheightValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addheight(uint value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "height", value.toString());
        }
    }

    public void addheight(String value) throws Exception {
        addheight(new uint(value));
    }
    ...
    public org.w3c.dom.Node getAdvancedwidthCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Attribute, null, "width", curNode);
    }

    public uint getwidthValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addwidth(uint value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "width", value.toString());
        }
    }

    public void addwidth(String value) throws Exception {
        addwidth(new uint(value));
    }
    ...
    public org.w3c.dom.Node getAdvanceddepthCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Attribute, null, "depth", curNode);
    }

    public uint getdepthValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void adddepth(uint value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "depth", value.toString());
        }
    }

    public void adddepth(String value) throws Exception {
        adddepth(new uint(value));
    }
    ...
    public int getdataCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "data");
    }
    ...
    public ListOfHexBinary getdataAt(int index) throws Exception {
        return new ListOfHexBinary(getDomNodeValue(dereference(getDomChildAt(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "data", index))));
    }
    ...
    public org.w3c.dom.Node getAdvanceddataCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "data", curNode);
    }

    public ListOfHexBinary getdataValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new ListOfHexBinary(getDomNodeValue(dereference(curNode)));
    }
    ...
    public void removedataAt(int index) {
        removeDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "data", index);
    }
    ...
    public void adddata(ListOfHexBinary value) {
        if (value.isNull() == false) {
    ...
    public void adddata(String value) throws Exception {
        adddata(new ListOfHexBinary(value));
    }
    ...
    public SchemaString getinit_fromValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addinit_from(SchemaString value) {
        if (value.isNull() == false) {
            appendDomChild(Element,
                    "http://www.collada.org/2005/11/COLLADASchema",
                    "init_from", value.toString());
        }
    }

    public void addinit_from(String value) throws Exception {
        addinit_from(new SchemaString(value));
    }
