/**
 * int_arrayType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class int_arrayType extends com.jmex.model.collada.xml.Node {
...
public int_arrayType(int_arrayType node) {
    ...
    public int_arrayType(com.jmex.model.collada.xml.Document doc,
            String namespaceURI, String prefix, String name) {
        super(doc, namespaceURI, prefix, name);
    }

    public ListOfInts getValue() {
        return new ListOfInts(getDomNodeValue(dereference(domNode)));
    }
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "minInclusive"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "minInclusive", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "maxInclusive"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "maxInclusive", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
    }
    ...
    public SchemaInteger getminInclusiveAt(int index) throws Exception {
        return new SchemaInteger(getDomNodeValue(dereference(getDomChildAt(
                Attribute, null, "minInclusive", index))));
    }
    ...
    public org.w3c.dom.Node getAdvancedminInclusiveCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Attribute, null, "minInclusive", curNode);
    }

    public SchemaInteger getminInclusiveValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void removeminInclusive() {
        while (hasminInclusive())
            removeminInclusiveAt(0);
    }

    public void addminInclusive(SchemaInteger value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "minInclusive", value.toString());
        }
    }

    public void addminInclusive(String value) throws Exception {
        addminInclusive(new SchemaInteger(value));
    }

    public void insertminInclusiveAt(SchemaInteger value, int index) {
        insertDomChildAt(Attribute, null, "minInclusive", index, value
                .toString());
    }
    ...
    public void replaceminInclusiveAt(SchemaInteger value, int index) {
        replaceDomChildAt(Attribute, null, "minInclusive", index, value
                .toString());
    }
    ...
    public SchemaInteger getmaxInclusiveAt(int index) throws Exception {
        return new SchemaInteger(getDomNodeValue(dereference(getDomChildAt(
                Attribute, null, "maxInclusive", index))));
    }
    ...
    public org.w3c.dom.Node getAdvancedmaxInclusiveCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Attribute, null, "maxInclusive", curNode);
    }

    public SchemaInteger getmaxInclusiveValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void removemaxInclusive() {
        while (hasmaxInclusive())
            removemaxInclusiveAt(0);
    }

    public void addmaxInclusive(SchemaInteger value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "maxInclusive", value.toString());
        }
    }

    public void addmaxInclusive(String value) throws Exception {
        addmaxInclusive(new SchemaInteger(value));
    }

    public void insertmaxInclusiveAt(SchemaInteger value, int index) {
        insertDomChildAt(Attribute, null, "maxInclusive", index, value
                .toString());
    }
    ...
    public void replacemaxInclusiveAt(SchemaInteger value, int index) {
        replaceDomChildAt(Attribute, null, "maxInclusive", index, value
                .toString());
    }
