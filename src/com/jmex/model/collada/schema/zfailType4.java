/**
 * zfailType4.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class zfailType4 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public zfailType4(zfailType4 node) {
        super(node);
    }

    public zfailType4(org.w3c.dom.Node node) {
        super(node);
    }

    public zfailType4(org.w3c.dom.Document doc) {
        super(doc);
    }

    public zfailType4(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_stencil_op_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new gl_stencil_op_type(getDomNodeValue(dereference(curNode)));
    }
    ...
    public void addvalue2(gl_stencil_op_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_stencil_op_type(value));
    }
