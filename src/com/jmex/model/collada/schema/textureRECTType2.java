/**
 * textureRECTType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class textureRECTType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public textureRECTType2(textureRECTType2 node) {
        super(node);
    }

    public textureRECTType2(org.w3c.dom.Node node) {
        super(node);
    }

    public textureRECTType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public textureRECTType2(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_samplerRECT newvalue2() {
        return new gl_samplerRECT(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "value"));
    }

    public gl_samplerRECT getvalue2At(int index) throws Exception {
        return new gl_samplerRECT(
    ...
    public gl_samplerRECT getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public gl_samplerRECT getvalue2() throws Exception {
    ...
    public void addvalue2(gl_samplerRECT value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "value", value);
    }

    public void insertvalue2At(gl_samplerRECT value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "value", index, value);
    }

    public void replacevalue2At(gl_samplerRECT value, int index) {
