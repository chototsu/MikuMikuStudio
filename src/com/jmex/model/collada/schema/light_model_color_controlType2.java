/**
 * light_model_color_controlType2.java This file was generated by XMLSpy 2006sp2
...
public class light_model_color_controlType2 extends
        com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public light_model_color_controlType2(light_model_color_controlType2 node) {
        super(node);
    }

    public light_model_color_controlType2(org.w3c.dom.Node node) {
        super(node);
    }

    public light_model_color_controlType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_model_color_controlType2(
    ...
    public gl_light_model_color_control_type getvalue2At(int index)
            throws Exception {
        return new gl_light_model_color_control_type(
    ...
    public gl_light_model_color_control_type getvalue2ValueAtCursor(
    ...
    public void addvalue2(gl_light_model_color_control_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_light_model_color_control_type(value));
    }

    public void insertvalue2At(gl_light_model_color_control_type value,
            int index) {
    ...
    public void replacevalue2At(gl_light_model_color_control_type value,
            int index) {
