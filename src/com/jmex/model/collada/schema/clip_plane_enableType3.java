/**
 * clip_plane_enableType3.java This file was generated by XMLSpy 2006sp2
...
public class clip_plane_enableType3 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public clip_plane_enableType3(clip_plane_enableType3 node) {
        super(node);
    }

    public clip_plane_enableType3(org.w3c.dom.Node node) {
        super(node);
    }

    public clip_plane_enableType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public clip_plane_enableType3(com.jmex.model.collada.xml.Document doc,
    ...
    public bool getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addvalue2(bool value) {
    ...
    public GL_MAX_CLIP_PLANES_index getindexValueAtCursor(
    ...
    public void addindex(GL_MAX_CLIP_PLANES_index value) {
        if (value.isNull() == false) {
    ...
    public void addindex(String value) throws Exception {
        addindex(new GL_MAX_CLIP_PLANES_index(value));
    }
