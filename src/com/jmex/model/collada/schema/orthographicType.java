/**
 * orthographicType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class orthographicType extends com.jmex.model.collada.xml.Node {
    ...
    public orthographicType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "xmag"); tmpNode != null; tmpNode = getDomNextChild(
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "ymag"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "ymag", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new TargetableFloat(tmpNode).adjustPrefix();
    ...
    public int getxmagCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "xmag");
    }
    ...
    public TargetableFloat getxmagAt(int index) throws Exception {
        return new TargetableFloat(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "xmag", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedxmagCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "xmag", curNode);
    }

    public TargetableFloat getxmagValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addxmag(TargetableFloat value) {
    ...
    public int getymagCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "ymag");
    }
    ...
    public TargetableFloat getymagAt(int index) throws Exception {
        return new TargetableFloat(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "ymag", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedymagCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "ymag", curNode);
    }

    public TargetableFloat getymagValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addymag(TargetableFloat value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "ymag", value);
    }
