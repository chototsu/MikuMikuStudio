...
public class clip_plane_enableType extends com.jmex.xml.xml.Node {

	public clip_plane_enableType(clip_plane_enableType node) {
		super(node);
	}

	public clip_plane_enableType(org.w3c.dom.Node node) {
		super(node);
	}

	public clip_plane_enableType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public clip_plane_enableType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "clip_plane_enable");
	}
	...
	public SchemaNCName getparam() throws Exception 
 {
	...
	public GL_MAX_CLIP_PLANES_index newindex() {
		return new GL_MAX_CLIP_PLANES_index();
	}

	public GL_MAX_CLIP_PLANES_index getindexAt(int index) throws Exception {
		return new GL_MAX_CLIP_PLANES_index(getDomNodeValue(getDomChildAt(Attribute, null, "index", index)));
	}
	...
	public GL_MAX_CLIP_PLANES_index getindexValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new GL_MAX_CLIP_PLANES_index(getDomNodeValue(curNode));
	}

	public GL_MAX_CLIP_PLANES_index getindex() throws Exception 
 {
		return getindexAt(0);
	}
	...
	public org.w3c.dom.Node addindex(GL_MAX_CLIP_PLANES_index value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addindex(String value) throws Exception {
		return addindex(new GL_MAX_CLIP_PLANES_index(value));
	}

	public void insertindexAt(GL_MAX_CLIP_PLANES_index value, int index) {
	...
	public void insertindexAt(String value, int index) throws Exception {
		insertindexAt(new GL_MAX_CLIP_PLANES_index(value), index);
	}

	public void replaceindexAt(GL_MAX_CLIP_PLANES_index value, int index) {
	...
	public void replaceindexAt(String value, int index) throws Exception {
		replaceindexAt(new GL_MAX_CLIP_PLANES_index(value), index);
	}
