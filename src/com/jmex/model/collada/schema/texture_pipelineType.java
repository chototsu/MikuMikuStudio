...
public class texture_pipelineType extends com.jmex.xml.xml.Node {
	...
	public texture_pipelineType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "texture_pipeline");
	}
	...
	public SchemaNCName getparam() throws Exception 
 {
	...
	public gles_texture_pipeline newvalue2() {
		return new gles_texture_pipeline(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "value"));
	}

	public gles_texture_pipeline getvalue2At(int index) throws Exception {
		return new gles_texture_pipeline(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "value", index));
	}
	...
	public gles_texture_pipeline getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
	...
	public gles_texture_pipeline getvalue2() throws Exception 
 {
	...
	public org.w3c.dom.Node addvalue2(gles_texture_pipeline value) {
