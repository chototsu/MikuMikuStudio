/**
 * texture_pipelineType.java This file was generated by XMLSpy 2006sp2
...
public class texture_pipelineType extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public texture_pipelineType(texture_pipelineType node) {
        super(node);
    }

    public texture_pipelineType(org.w3c.dom.Node node) {
        super(node);
    }

    public texture_pipelineType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public texture_pipelineType(com.jmex.model.collada.xml.Document doc,
    ...
    public gles_texture_pipeline newvalue2() {
        return new gles_texture_pipeline(
    ...
    public gles_texture_pipeline getvalue2At(int index) throws Exception {
        return new gles_texture_pipeline(
    ...
    public gles_texture_pipeline getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public gles_texture_pipeline getvalue2() throws Exception {
    ...
    public void addvalue2(gles_texture_pipeline value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "value", value);
    }

    public void insertvalue2At(gles_texture_pipeline value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "value", index, value);
    }

    public void replacevalue2At(gles_texture_pipeline value, int index) {
