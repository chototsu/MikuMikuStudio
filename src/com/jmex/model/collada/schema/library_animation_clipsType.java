/**
 * library_animation_clipsType.java This file was generated by XMLSpy 2006sp2
...
public class library_animation_clipsType extends
    ...
    public library_animation_clipsType(
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                ...
                "animation_clip"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "animation_clip", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public animation_clipType newanimation_clip() {
        return new animation_clipType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "animation_clip"));
    }
    ...
    public animation_clipType getanimation_clipAt(int index) throws Exception {
        return new animation_clipType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "animation_clip", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedanimation_clipCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "animation_clip", curNode);
    }

    public animation_clipType getanimation_clipValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new animation_clipType(dereference(curNode));
    }
    ...
    public void addanimation_clip(animation_clipType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "animation_clip", value);
    }

    public void insertanimation_clipAt(animation_clipType value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "animation_clip", index, value);
    }
