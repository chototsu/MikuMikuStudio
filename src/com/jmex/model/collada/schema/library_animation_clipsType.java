/**
 * library_animation_clipsType.java
 *
...
public class library_animation_clipsType extends com.jmex.xml.xml.Node {

	public library_animation_clipsType(library_animation_clipsType node) {
		super(node);
	}

	public library_animation_clipsType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_animation_clipsType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_animation_clipsType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new animation_clipType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_animation_clips");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getanimation_clipMinCount() {
		return 1;
	}

	public static int getanimation_clipMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getanimation_clipCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip");
	}

	public boolean hasanimation_clip() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip");
	}

	public animation_clipType newanimation_clip() {
		return new animation_clipType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "animation_clip"));
	}

	public animation_clipType getanimation_clipAt(int index) throws Exception {
		return new animation_clipType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip", index));
	}

	public org.w3c.dom.Node getStartinganimation_clipCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip" );
	}

	public org.w3c.dom.Node getAdvancedanimation_clipCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip", curNode );
	}

	public animation_clipType getanimation_clipValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new animation_clipType(curNode);
	}

	public animation_clipType getanimation_clip() throws Exception 
 {
		return getanimation_clipAt(0);
	}

	public void removeanimation_clipAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "animation_clip", index);
	}

	public void removeanimation_clip() {
		while (hasanimation_clip())
			removeanimation_clipAt(0);
	}

	public org.w3c.dom.Node addanimation_clip(animation_clipType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "animation_clip", value);
	}

	public void insertanimation_clipAt(animation_clipType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "animation_clip", index, value);
	}

	public void replaceanimation_clipAt(animation_clipType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "animation_clip", index, value);
	}
