/**
 * stencil_funcType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class stencil_funcType extends com.jmex.model.collada.xml.Node {
    ...
    public stencil_funcType(com.jmex.model.collada.xml.Document doc,
    ...
    public funcType2 newfunc() {
        return new funcType2(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "func"));
    }

    public funcType2 getfuncAt(int index) throws Exception {
        return new funcType2(dereference(getDomChildAt(Element,
    ...
    public funcType2 getfuncValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new funcType2(dereference(curNode));
    }
    ...
    public void addfunc(funcType2 value) {
    ...
    public refType newref() {
        return new refType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "ref"));
    }

    public refType getrefAt(int index) throws Exception {
        return new refType(dereference(getDomChildAt(Element,
    ...
    public refType getrefValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new refType(dereference(curNode));
    }
    ...
    public void addref(refType value) {
    ...
    public maskType newmask() {
        return new maskType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "mask"));
    }

    public maskType getmaskAt(int index) throws Exception {
        return new maskType(dereference(getDomChildAt(Element,
    ...
    public maskType getmaskValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new maskType(dereference(curNode));
    }
    ...
    public void addmask(maskType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "mask", value);
    }
