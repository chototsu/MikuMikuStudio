/**
 * colorType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class colorType extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public colorType(colorType node) {
        super(node);
    }

    public colorType(org.w3c.dom.Node node) {
        super(node);
    }

    public colorType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public colorType(com.jmex.model.collada.xml.Document doc,
            String namespaceURI, String prefix, String name) {
        super(doc, namespaceURI, prefix, name);
    }

    public fx_color_common getValue() {
        return new fx_color_common(getDomNodeValue(dereference(domNode)));
    }
