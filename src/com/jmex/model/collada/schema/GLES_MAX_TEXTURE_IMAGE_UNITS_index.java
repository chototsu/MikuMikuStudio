/**
 * GLES_MAX_TEXTURE_IMAGE_UNITS_index.java This file was generated by XMLSpy
...
public class GLES_MAX_TEXTURE_IMAGE_UNITS_index extends SchemaInteger {

    private static final long serialVersionUID = 1L;

    public GLES_MAX_TEXTURE_IMAGE_UNITS_index() {
        super();
    }

    public GLES_MAX_TEXTURE_IMAGE_UNITS_index(String newValue) {
        super(newValue);
        validate();
    }

    public GLES_MAX_TEXTURE_IMAGE_UNITS_index(SchemaInteger newValue) {
        super(newValue);
        validate();
    }
    ...
    public void validate() {
        ...
        if (compareTo(getMaxExclusive()) >= 0)
            throw new com.jmex.model.collada.xml.XmlException(
                    "Value of GLES_MAX_TEXTURE_IMAGE_UNITS_index is out of range.");
