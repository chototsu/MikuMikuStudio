/**
 * texture_env_modeType.java This file was generated by XMLSpy 2006sp2
...
public class texture_env_modeType extends com.jmex.model.collada.xml.Node {
    ...
    public texture_env_modeType(com.jmex.model.collada.xml.Document doc,
    ...
    public string getvalue2At(int index) throws Exception {
        return new string(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public string getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new string(getDomNodeValue(dereference(curNode)));
    }
