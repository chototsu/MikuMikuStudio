...
public class shade_modelType2 extends com.jmex.xml.xml.Node {
	...
	public shade_modelType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "shade_model");
	}
	...
	public gl_shade_model_type getvalue2At(int index) throws Exception {
		return new gl_shade_model_type(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
	}
	...
	public gl_shade_model_type getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new gl_shade_model_type(getDomNodeValue(curNode));
	}
	...
	public gl_shade_model_type getvalue2() throws Exception 
 {
	...
	public org.w3c.dom.Node addvalue2(gl_shade_model_type value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addvalue2(String value) throws Exception {
		return addvalue2(new gl_shade_model_type(value));
	}
