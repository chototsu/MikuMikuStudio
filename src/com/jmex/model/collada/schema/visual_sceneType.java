/**
 * visual_sceneType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class visual_sceneType extends com.jmex.model.collada.xml.Node {
    ...
    public visual_sceneType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                ...
                "evaluate_scene"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "evaluate_scene", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public evaluate_sceneType newevaluate_scene() {
        return new evaluate_sceneType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "evaluate_scene"));
    }
    ...
    public evaluate_sceneType getevaluate_sceneAt(int index) throws Exception {
        return new evaluate_sceneType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "evaluate_scene", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedevaluate_sceneCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "evaluate_scene", curNode);
    }

    public evaluate_sceneType getevaluate_sceneValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new evaluate_sceneType(dereference(curNode));
    }
    ...
    public void addevaluate_scene(evaluate_sceneType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "evaluate_scene", value);
    }

    public void insertevaluate_sceneAt(evaluate_sceneType value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "evaluate_scene", index, value);
    }
