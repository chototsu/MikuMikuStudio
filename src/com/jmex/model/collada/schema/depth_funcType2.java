/**
 * depth_funcType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class depth_funcType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public depth_funcType2(depth_funcType2 node) {
        super(node);
    }

    public depth_funcType2(org.w3c.dom.Node node) {
        super(node);
    }

    public depth_funcType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public depth_funcType2(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_func_type getvalue2At(int index) throws Exception {
        return new gl_func_type(getDomNodeValue(dereference(getDomChildAt(
    ...
    public gl_func_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new gl_func_type(getDomNodeValue(dereference(curNode)));
    }
    ...
    public void addvalue2(gl_func_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_func_type(value));
    }
