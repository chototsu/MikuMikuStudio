/**
 * library_physics_modelsType.java This file was generated by XMLSpy 2006sp2
...
public class library_physics_modelsType extends
    ...
    public library_physics_modelsType(
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "physics_model"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "physics_model", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getphysics_modelCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "physics_model");
    }
    ...
    public physics_modelType newphysics_model() {
        return new physics_modelType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "physics_model"));
    }
    ...
    public physics_modelType getphysics_modelAt(int index) throws Exception {
        return new physics_modelType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "physics_model", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedphysics_modelCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "physics_model", curNode);
    }

    public physics_modelType getphysics_modelValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new physics_modelType(dereference(curNode));
    }
    ...
    public void addphysics_model(physics_modelType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "physics_model", value);
    }
