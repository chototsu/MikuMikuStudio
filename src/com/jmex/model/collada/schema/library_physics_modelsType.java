/**
 * library_physics_modelsType.java
 *
...
public class library_physics_modelsType extends com.jmex.xml.xml.Node {

	public library_physics_modelsType(library_physics_modelsType node) {
		super(node);
	}

	public library_physics_modelsType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_physics_modelsType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_physics_modelsType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new physics_modelType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_physics_models");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getphysics_modelMinCount() {
		return 1;
	}

	public static int getphysics_modelMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getphysics_modelCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model");
	}

	public boolean hasphysics_model() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model");
	}

	public physics_modelType newphysics_model() {
		return new physics_modelType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "physics_model"));
	}

	public physics_modelType getphysics_modelAt(int index) throws Exception {
		return new physics_modelType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model", index));
	}

	public org.w3c.dom.Node getStartingphysics_modelCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model" );
	}

	public org.w3c.dom.Node getAdvancedphysics_modelCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model", curNode );
	}

	public physics_modelType getphysics_modelValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new physics_modelType(curNode);
	}

	public physics_modelType getphysics_model() throws Exception 
 {
		return getphysics_modelAt(0);
	}

	public void removephysics_modelAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_model", index);
	}

	public void removephysics_model() {
		while (hasphysics_model())
			removephysics_modelAt(0);
	}

	public org.w3c.dom.Node addphysics_model(physics_modelType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "physics_model", value);
	}

	public void insertphysics_modelAt(physics_modelType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "physics_model", index, value);
	}

	public void replacephysics_modelAt(physics_modelType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "physics_model", index, value);
	}
