/**
 * float3.java This file was generated by XMLSpy 2006sp2 Enterprise Edition. YOU
...
public class float3 extends ListOfFloats {
    ...
    public float3(String newValue) {
        super(newValue);
        validate();
    }

    public float3(SchemaString newValue) {
        super(newValue);
        validate();
    }
