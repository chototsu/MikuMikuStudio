/**
 * gles_sampler_wrap.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class gles_sampler_wrap extends SchemaNMToken {
    ...
    public static String[] sEnumValues = { "REPEAT", "CLAMP", "CLAMP_TO_EDGE",
            "MIRRORED_REPEAT", };
    ...
    public void validate() {
        ...
        if (!isValidEnumerationValue(toString()))
            throw new com.jmex.model.collada.xml.XmlException(
                    "Value of gles_sampler_wrap is invalid.");
    }
}
