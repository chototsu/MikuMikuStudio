/**
 * convex_meshType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class convex_meshType extends com.jmex.model.collada.xml.Node {
    ...
    public convex_meshType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "convex_hull_of"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "convex_hull_of", tmpNode)) {
    ...
    public SchemaString getconvex_hull_ofAt(int index) throws Exception {
        return new SchemaString(getDomNodeValue(dereference(getDomChildAt(
                Attribute, null, "convex_hull_of", index))));
    }
    ...
    public org.w3c.dom.Node getAdvancedconvex_hull_ofCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Attribute, null, "convex_hull_of", curNode);
    }

    public SchemaString getconvex_hull_ofValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void removeconvex_hull_of() {
        while (hasconvex_hull_of())
            removeconvex_hull_ofAt(0);
    }

    public void addconvex_hull_of(SchemaString value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "convex_hull_of", value.toString());
        }
    }

    public void addconvex_hull_of(String value) throws Exception {
        addconvex_hull_of(new SchemaString(value));
    }

    public void insertconvex_hull_ofAt(SchemaString value, int index) {
        insertDomChildAt(Attribute, null, "convex_hull_of", index, value
                .toString());
    }

    public void insertconvex_hull_ofAt(String value, int index)
            throws Exception {
        insertconvex_hull_ofAt(new SchemaString(value), index);
    }

    public void replaceconvex_hull_ofAt(SchemaString value, int index) {
        replaceDomChildAt(Attribute, null, "convex_hull_of", index, value
                .toString());
    }

    public void replaceconvex_hull_ofAt(String value, int index)
            throws Exception {
