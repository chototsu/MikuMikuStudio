/**
 * generatorType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class generatorType extends com.jmex.model.collada.xml.Node {
    ...
    public generatorType(com.jmex.model.collada.xml.Document doc,
    ...
    public nameType newname() {
        return new nameType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "name"));
    }

    public nameType getnameAt(int index) throws Exception {
        return new nameType(dereference(getDomChildAt(Element,
    ...
    public nameType getnameValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public cg_setparam_simple newsetparam() {
        return new cg_setparam_simple(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "setparam"));
    }
    ...
    public cg_setparam_simple getsetparamAt(int index) throws Exception {
        return new cg_setparam_simple(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "setparam",
                index)));
    }
    ...
    public cg_setparam_simple getsetparamValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new cg_setparam_simple(dereference(curNode));
    }
    ...
    public void addsetparam(cg_setparam_simple value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "setparam", value);
    }
