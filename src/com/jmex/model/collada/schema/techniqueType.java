/**
 * techniqueType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class techniqueType extends com.jmex.model.collada.xml.Node {
    ...
    public techniqueType(com.jmex.model.collada.xml.Document doc,
    ...
    public cg_newparam newnewparam() {
        return new cg_newparam(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "newparam"));
    }

    public cg_newparam getnewparamAt(int index) throws Exception {
        return new cg_newparam(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "newparam",
                index)));
    }
    ...
    public cg_newparam getnewparamValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new cg_newparam(dereference(curNode));
    }
    ...
    public void addnewparam(cg_newparam value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "newparam", value);
    }
    ...
    public cg_setparam newsetparam() {
        return new cg_setparam(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "setparam"));
    }

    public cg_setparam getsetparamAt(int index) throws Exception {
        return new cg_setparam(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "setparam",
                index)));
    }
    ...
    public cg_setparam getsetparamValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new cg_setparam(dereference(curNode));
    }
    ...
    public void addsetparam(cg_setparam value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "setparam", value);
    }
    ...
    public passType newpass() {
        return new passType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "pass"));
    }

    public passType getpassAt(int index) throws Exception {
        return new passType(dereference(getDomChildAt(Element,
    ...
    public passType getpassValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new passType(dereference(curNode));
    }
    ...
    public void addpass(passType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "pass", value);
    }
