/**
 * library_force_fieldsType.java This file was generated by XMLSpy 2006sp2
...
public class library_force_fieldsType extends
    ...
    public library_force_fieldsType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "force_field"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "force_field", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getforce_fieldCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "force_field");
    }
    ...
    public force_fieldType newforce_field() {
        return new force_fieldType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "force_field"));
    }

    public force_fieldType getforce_fieldAt(int index) throws Exception {
        return new force_fieldType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "force_field",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedforce_fieldCursor(
    ...
    public force_fieldType getforce_fieldValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new force_fieldType(dereference(curNode));
    }
    ...
    public void addforce_field(force_fieldType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "force_field", value);
    }
