...
public class library_force_fieldsType extends com.jmex.xml.xml.Node {

	public library_force_fieldsType(library_force_fieldsType node) {
		super(node);
	}

	public library_force_fieldsType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_force_fieldsType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_force_fieldsType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new force_fieldType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_force_fields");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getforce_fieldMinCount() {
		return 1;
	}

	public static int getforce_fieldMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getforce_fieldCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field");
	}

	public boolean hasforce_field() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field");
	}

	public force_fieldType newforce_field() {
		return new force_fieldType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "force_field"));
	}

	public force_fieldType getforce_fieldAt(int index) throws Exception {
		return new force_fieldType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field", index));
	}

	public org.w3c.dom.Node getStartingforce_fieldCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field" );
	}

	public org.w3c.dom.Node getAdvancedforce_fieldCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field", curNode );
	}

	public force_fieldType getforce_fieldValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new force_fieldType(curNode);
	}

	public force_fieldType getforce_field() throws Exception 
 {
		return getforce_fieldAt(0);
	}

	public void removeforce_fieldAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "force_field", index);
	}

	public void removeforce_field() {
		while (hasforce_field())
			removeforce_fieldAt(0);
	}

	public org.w3c.dom.Node addforce_field(force_fieldType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "force_field", value);
	}

	public void insertforce_fieldAt(force_fieldType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "force_field", index, value);
	}

	public void replaceforce_fieldAt(force_fieldType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "force_field", index, value);
	}
