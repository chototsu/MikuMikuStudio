/**
 * light_model_two_side_enableType.java This file was generated by XMLSpy
...
public class light_model_two_side_enableType extends
        com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public light_model_two_side_enableType(light_model_two_side_enableType node) {
        super(node);
    }

    public light_model_two_side_enableType(org.w3c.dom.Node node) {
        super(node);
    }

    public light_model_two_side_enableType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_model_two_side_enableType(
