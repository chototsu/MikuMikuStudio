/**
 * light_enableType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class light_enableType2 extends com.jmex.model.collada.xml.Node {
    ...
    public light_enableType2(com.jmex.model.collada.xml.Document doc,
    ...
    public GLES_MAX_LIGHTS_index getindexValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addindex(GLES_MAX_LIGHTS_index value) {
        if (value.isNull() == false) {
    ...
    public void addindex(String value) throws Exception {
        addindex(new GLES_MAX_LIGHTS_index(value));
    }
