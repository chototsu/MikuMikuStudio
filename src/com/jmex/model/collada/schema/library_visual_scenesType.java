/**
 * library_visual_scenesType.java This file was generated by XMLSpy 2006sp2
...
public class library_visual_scenesType extends
    ...
    public library_visual_scenesType(
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "visual_scene"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "visual_scene", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getvisual_sceneCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "visual_scene");
    }
    ...
    public visual_sceneType newvisual_scene() {
        return new visual_sceneType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "visual_scene"));
    }

    public visual_sceneType getvisual_sceneAt(int index) throws Exception {
        return new visual_sceneType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "visual_scene",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedvisual_sceneCursor(
    ...
    public visual_sceneType getvisual_sceneValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new visual_sceneType(dereference(curNode));
    }
    ...
    public void addvisual_scene(visual_sceneType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "visual_scene", value);
    }
