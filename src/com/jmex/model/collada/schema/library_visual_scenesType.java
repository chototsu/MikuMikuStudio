/**
 * library_visual_scenesType.java
 *
...
public class library_visual_scenesType extends com.jmex.xml.xml.Node {

	public library_visual_scenesType(library_visual_scenesType node) {
		super(node);
	}

	public library_visual_scenesType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_visual_scenesType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_visual_scenesType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new visual_sceneType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_visual_scenes");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getvisual_sceneMinCount() {
		return 1;
	}

	public static int getvisual_sceneMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getvisual_sceneCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene");
	}

	public boolean hasvisual_scene() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene");
	}

	public visual_sceneType newvisual_scene() {
		return new visual_sceneType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "visual_scene"));
	}

	public visual_sceneType getvisual_sceneAt(int index) throws Exception {
		return new visual_sceneType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene", index));
	}

	public org.w3c.dom.Node getStartingvisual_sceneCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene" );
	}

	public org.w3c.dom.Node getAdvancedvisual_sceneCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene", curNode );
	}

	public visual_sceneType getvisual_sceneValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new visual_sceneType(curNode);
	}

	public visual_sceneType getvisual_scene() throws Exception 
 {
		return getvisual_sceneAt(0);
	}

	public void removevisual_sceneAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "visual_scene", index);
	}

	public void removevisual_scene() {
		while (hasvisual_scene())
			removevisual_sceneAt(0);
	}

	public org.w3c.dom.Node addvisual_scene(visual_sceneType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "visual_scene", value);
	}

	public void insertvisual_sceneAt(visual_sceneType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "visual_scene", index, value);
	}

	public void replacevisual_sceneAt(visual_sceneType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "visual_scene", index, value);
	}
