/**
 * scissorType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class scissorType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public scissorType2(scissorType2 node) {
        super(node);
    }

    public scissorType2(org.w3c.dom.Node node) {
        super(node);
    }

    public scissorType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public scissorType2(com.jmex.model.collada.xml.Document doc,
    ...
    public int4 newvalue2() {
        return new int4();
    }

    public int4 getvalue2At(int index) throws Exception {
        return new int4(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public int4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public int4 getvalue2() throws Exception {
    ...
    public void addvalue2(int4 value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new int4(value));
    }

    public void insertvalue2At(int4 value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new int4(value), index);
    }

    public void replacevalue2At(int4 value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new int4(value), index);
    }
