...
public class front_faceType2 extends com.jmex.xml.xml.Node {
	...
	public front_faceType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public gl_front_face_type getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			...
			return new gl_front_face_type(getDomNodeValue(curNode));
	}
