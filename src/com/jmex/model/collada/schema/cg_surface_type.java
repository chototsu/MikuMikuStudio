...
public class cg_surface_type extends fx_surface_common {
	...
	public cg_surface_type(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public generatorType getgeneratorValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			...
			return new generatorType(curNode);
	}
