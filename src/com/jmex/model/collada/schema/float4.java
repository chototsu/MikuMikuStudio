/**
 * float4.java This file was generated by XMLSpy 2006sp2 Enterprise Edition. YOU
...
public class float4 extends ListOfFloats {
    ...
    public float4(String newValue) {
        super(newValue);
        validate();
    }

    public float4(SchemaString newValue) {
        super(newValue);
        validate();
    }
