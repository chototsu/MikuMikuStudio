/**
 * glsl_newparam.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class glsl_newparam extends com.jmex.model.collada.xml.Node {
    ...
    public glsl_newparam(com.jmex.model.collada.xml.Document doc,
    ...
    public glsl_identifier getsidAt(int index) throws Exception {
        return new glsl_identifier(getDomNodeValue(dereference(getDomChildAt(
    ...
    public glsl_identifier getsidValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new glsl_identifier(getDomNodeValue(dereference(curNode)));
    }
    ...
    public void addsid(glsl_identifier value) {
    ...
    public void addsid(String value) throws Exception {
        addsid(new glsl_identifier(value));
    }
    ...
    public glsl_newarray_type getarrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new glsl_newarray_type(dereference(curNode));
    }
    ...
    public void addarray(glsl_newarray_type value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "array", value);
    }
