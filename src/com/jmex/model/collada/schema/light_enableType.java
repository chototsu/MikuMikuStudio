...
public class light_enableType extends com.jmex.xml.xml.Node {
	...
	public light_enableType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public SchemaNCName getparam() throws Exception 
 {
	...
	public GL_MAX_LIGHTS_index getindexAt(int index) throws Exception {
		return new GL_MAX_LIGHTS_index(getDomNodeValue(getDomChildAt(Attribute, null, "index", index)));
	}
	...
	public GL_MAX_LIGHTS_index getindexValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new GL_MAX_LIGHTS_index(getDomNodeValue(curNode));
	}
	...
	public GL_MAX_LIGHTS_index getindex() throws Exception 
 {
	...
	public org.w3c.dom.Node addindex(GL_MAX_LIGHTS_index value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addindex(String value) throws Exception {
		return addindex(new GL_MAX_LIGHTS_index(value));
	}
