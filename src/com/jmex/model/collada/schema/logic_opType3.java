/**
 * logic_opType3.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class logic_opType3 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public logic_opType3(logic_opType3 node) {
        super(node);
    }

    public logic_opType3(org.w3c.dom.Node node) {
        super(node);
    }

    public logic_opType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public logic_opType3(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_logic_op_type newvalue2() {
        return new gl_logic_op_type();
    }

    public gl_logic_op_type getvalue2At(int index) throws Exception {
        return new gl_logic_op_type(getDomNodeValue(dereference(getDomChildAt(
    ...
    public gl_logic_op_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new gl_logic_op_type(getDomNodeValue(dereference(curNode)));
    }

    public gl_logic_op_type getvalue2() throws Exception {
    ...
    public void addvalue2(gl_logic_op_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_logic_op_type(value));
    }

    public void insertvalue2At(gl_logic_op_type value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new gl_logic_op_type(value), index);
    }

    public void replacevalue2At(gl_logic_op_type value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new gl_logic_op_type(value), index);
    }
