/**
 * GLES_MAX_TEXTURE_COORDS_index.java This file was generated by XMLSpy 2006sp2
...
public class GLES_MAX_TEXTURE_COORDS_index extends SchemaInteger {
    ...
    public GLES_MAX_TEXTURE_COORDS_index(String newValue) {
        super(newValue);
        validate();
    }

    public GLES_MAX_TEXTURE_COORDS_index(SchemaInteger newValue) {
        super(newValue);
        validate();
    }
    ...
    public void validate() {
        ...
        if (compareTo(getMaxExclusive()) >= 0)
            throw new com.jmex.model.collada.xml.XmlException(
                    "Value of GLES_MAX_TEXTURE_COORDS_index is out of range.");
