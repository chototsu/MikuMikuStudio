...
public class rigid_bodyType extends com.jmex.xml.xml.Node {
	...
	public rigid_bodyType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "rigid_body");
	}
	...
	public SchemaNCName getname() throws Exception 
 {
	...
	public technique_commonType7 newtechnique_common() {
		return new technique_commonType7(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "technique_common"));
	}

	public technique_commonType7 gettechnique_commonAt(int index) throws Exception {
		return new technique_commonType7(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "technique_common", index));
	}
	...
	public technique_commonType7 gettechnique_commonValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new technique_commonType7(curNode);
	}
	...
	public technique_commonType7 gettechnique_common() throws Exception 
 {
	...
	public org.w3c.dom.Node addtechnique_common(technique_commonType7 value) {
