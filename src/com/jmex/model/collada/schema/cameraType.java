/**
 * cameraType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class cameraType extends com.jmex.model.collada.xml.Node {
    ...
    public cameraType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "optics"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "optics", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "imager"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "imager", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getopticsCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "optics");
    }
    ...
    public opticsType newoptics() {
        return new opticsType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "optics"));
    }

    public opticsType getopticsAt(int index) throws Exception {
        return new opticsType(
                dereference(getDomChildAt(Element,
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "optics", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedopticsCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "optics",
                curNode);
    ...
    public opticsType getopticsValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new opticsType(dereference(curNode));
    }
    ...
    public void removeopticsAt(int index) {
        removeDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "optics", index);
    }
    ...
    public void addoptics(opticsType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "optics", value);
    }
    ...
    public int getimagerCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "imager");
    }
    ...
    public imagerType newimager() {
        return new imagerType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "imager"));
    }

    public imagerType getimagerAt(int index) throws Exception {
        return new imagerType(
                dereference(getDomChildAt(Element,
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "imager", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedimagerCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "imager",
                curNode);
    ...
    public imagerType getimagerValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new imagerType(dereference(curNode));
    }
    ...
    public void removeimagerAt(int index) {
        removeDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "imager", index);
    }
    ...
    public void addimager(imagerType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "imager", value);
    }
