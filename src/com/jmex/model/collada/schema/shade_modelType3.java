/**
 * shade_modelType3.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class shade_modelType3 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public shade_modelType3(shade_modelType3 node) {
        super(node);
    }

    public shade_modelType3(org.w3c.dom.Node node) {
        super(node);
    }

    public shade_modelType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public shade_modelType3(com.jmex.model.collada.xml.Document doc,
    ...
    public gl_shade_model_type newvalue2() {
        return new gl_shade_model_type();
    }

    public gl_shade_model_type getvalue2At(int index) throws Exception {
        return new gl_shade_model_type(
    ...
    public gl_shade_model_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public gl_shade_model_type getvalue2() throws Exception {
    ...
    public void addvalue2(gl_shade_model_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_shade_model_type(value));
    }

    public void insertvalue2At(gl_shade_model_type value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new gl_shade_model_type(value), index);
    }

    public void replacevalue2At(gl_shade_model_type value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new gl_shade_model_type(value), index);
    }
