/**
 * polygon_offset_point_enableType.java This file was generated by XMLSpy
...
public class polygon_offset_point_enableType extends
        com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public polygon_offset_point_enableType(polygon_offset_point_enableType node) {
        super(node);
    }

    public polygon_offset_point_enableType(org.w3c.dom.Node node) {
        super(node);
    }

    public polygon_offset_point_enableType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public polygon_offset_point_enableType(
