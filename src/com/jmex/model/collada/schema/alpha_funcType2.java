/**
 * alpha_funcType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class alpha_funcType2 extends com.jmex.model.collada.xml.Node {
    ...
    public alpha_funcType2(com.jmex.model.collada.xml.Document doc,
    ...
    public funcType3 newfunc() {
        return new funcType3(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "func"));
    }

    public funcType3 getfuncAt(int index) throws Exception {
        return new funcType3(dereference(getDomChildAt(Element,
    ...
    public funcType3 getfuncValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new funcType3(dereference(curNode));
    }
    ...
    public void addfunc(funcType3 value) {
    ...
    public valueType2 newvalue2() {
        return new valueType2(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "value"));
    }
    ...
    public valueType2 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new valueType2(dereference(curNode));
    }
    ...
    public void addvalue2(valueType2 value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "value", value);
    }
