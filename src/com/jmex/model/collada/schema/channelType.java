/**
 * channelType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class channelType extends com.jmex.model.collada.xml.Node {
    ...
    public channelType(com.jmex.model.collada.xml.Document doc,
    ...
    public SchemaToken gettargetValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addtarget(SchemaToken value) {
        if (value.isNull() == false) {
    ...
    public void addtarget(String value) throws Exception {
        addtarget(new SchemaToken(value));
    }
