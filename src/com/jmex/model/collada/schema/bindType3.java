...
public class bindType3 extends com.jmex.xml.xml.Node {
	...
	public bindType3(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public gl_enumeration getenum() throws Exception 
 {
	...
	public paramType5 newparam() {
		return new paramType5(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "param"));
	}

	public paramType5 getparamAt(int index) throws Exception {
		return new paramType5(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "param", index));
	}
	...
	public paramType5 getparamValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new paramType5(curNode);
	}
	...
	public paramType5 getparam() throws Exception 
 {
	...
	public org.w3c.dom.Node addparam(paramType5 value) {
