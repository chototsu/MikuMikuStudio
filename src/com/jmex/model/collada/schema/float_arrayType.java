/**
 * float_arrayType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class float_arrayType extends com.jmex.model.collada.xml.Node {
    ...
    public float_arrayType(com.jmex.model.collada.xml.Document doc,
            String namespaceURI, String prefix, String name) {
        super(doc, namespaceURI, prefix, name);
    }

    public ListOfFloats getValue() {
        return new ListOfFloats(getDomNodeValue(dereference(domNode)));
    }
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "digits"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "digits", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Attribute, null,
                "magnitude"); tmpNode != null; tmpNode = getDomNextChild(
                Attribute, null, "magnitude", tmpNode)) {
            internalAdjustPrefix(tmpNode, false);
        }
    }
    ...
    public org.w3c.dom.Node getAdvanceddigitsCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Attribute, null, "digits", curNode);
    }

    public SchemaShort getdigitsValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void adddigits(SchemaShort value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "digits", value.toString());
        }
    }

    public void adddigits(String value) throws Exception {
        adddigits(new SchemaShort(value));
    }
    ...
    public SchemaShort getmagnitudeAt(int index) throws Exception {
        return new SchemaShort(getDomNodeValue(dereference(getDomChildAt(
                Attribute, null, "magnitude", index))));
    }
    ...
    public org.w3c.dom.Node getAdvancedmagnitudeCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Attribute, null, "magnitude", curNode);
    }

    public SchemaShort getmagnitudeValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void addmagnitude(SchemaShort value) {
        if (value.isNull() == false) {
            appendDomChild(Attribute, null, "magnitude", value.toString());
        }
    }

    public void addmagnitude(String value) throws Exception {
        addmagnitude(new SchemaShort(value));
    }
