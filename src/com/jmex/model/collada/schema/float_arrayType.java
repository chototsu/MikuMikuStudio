...
public class float_arrayType extends com.jmex.xml.xml.Node {

	public float_arrayType(float_arrayType node) {
		super(node);
	}

	public float_arrayType(org.w3c.dom.Node node) {
		super(node);
	}

	public float_arrayType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public float_arrayType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
		super(doc, namespaceURI, prefix, name);
	}
	

	public ListOfFloats getValue() {
		return new ListOfFloats(getDomNodeValue(domNode));
	}
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Attribute, null, "digits" );
				tmpNode != null;
				tmpNode = getDomNextChild( Attribute, null, "digits", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
		}
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Attribute, null, "magnitude" );
				tmpNode != null;
				tmpNode = getDomNextChild( Attribute, null, "magnitude", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
		}
	}
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "float_array");
	}
	...
	public uint getcount() throws Exception 
 {
	...
	public static int getdigitsMinCount() {
		return 0;
	}

	public static int getdigitsMaxCount() {
		return 1;
	}

	public int getdigitsCount() {
		return getDomChildCount(Attribute, null, "digits");
	}

	public boolean hasdigits() {
		return hasDomChild(Attribute, null, "digits");
	}

	public SchemaShort newdigits() {
		return new SchemaShort();
	}

	public SchemaShort getdigitsAt(int index) throws Exception {
		return new SchemaShort(getDomNodeValue(getDomChildAt(Attribute, null, "digits", index)));
	}

	public org.w3c.dom.Node getStartingdigitsCursor() throws Exception {
		return getDomFirstChild(Attribute, null, "digits" );
	}

	public org.w3c.dom.Node getAdvanceddigitsCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Attribute, null, "digits", curNode );
	}

	public SchemaShort getdigitsValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
	...
	public SchemaShort getdigits() throws Exception 
 {
		return getdigitsAt(0);
	}

	public void removedigitsAt(int index) {
		removeDomChildAt(Attribute, null, "digits", index);
	}
	...
	public org.w3c.dom.Node adddigits(SchemaShort value) {
		if( value.isNull() )
			return null;

		return  appendDomChild(Attribute, null, "digits", value.toString());
	}

	public org.w3c.dom.Node adddigits(String value) throws Exception {
		return adddigits(new SchemaShort(value));
	}

	public void insertdigitsAt(SchemaShort value, int index) {
		insertDomChildAt(Attribute, null, "digits", index, value.toString());
	}

	public void insertdigitsAt(String value, int index) throws Exception {
		insertdigitsAt(new SchemaShort(value), index);
	}

	public void replacedigitsAt(SchemaShort value, int index) {
		replaceDomChildAt(Attribute, null, "digits", index, value.toString());
	}

	public void replacedigitsAt(String value, int index) throws Exception {
		replacedigitsAt(new SchemaShort(value), index);
	}

	public static int getmagnitudeMinCount() {
		return 0;
	}

	public static int getmagnitudeMaxCount() {
		return 1;
	}

	public int getmagnitudeCount() {
		return getDomChildCount(Attribute, null, "magnitude");
	}

	public boolean hasmagnitude() {
		return hasDomChild(Attribute, null, "magnitude");
	}

	public SchemaShort newmagnitude() {
		return new SchemaShort();
	}

	public SchemaShort getmagnitudeAt(int index) throws Exception {
		return new SchemaShort(getDomNodeValue(getDomChildAt(Attribute, null, "magnitude", index)));
	}

	public org.w3c.dom.Node getStartingmagnitudeCursor() throws Exception {
		return getDomFirstChild(Attribute, null, "magnitude" );
	}

	public org.w3c.dom.Node getAdvancedmagnitudeCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Attribute, null, "magnitude", curNode );
	}

	public SchemaShort getmagnitudeValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new SchemaShort(getDomNodeValue(curNode));
	...
	public SchemaShort getmagnitude() throws Exception 
 {
		return getmagnitudeAt(0);
	}

	public void removemagnitudeAt(int index) {
		removeDomChildAt(Attribute, null, "magnitude", index);
	}

	public void removemagnitude() {
		removemagnitudeAt(0);
	}

	public org.w3c.dom.Node addmagnitude(SchemaShort value) {
		if( value.isNull() )
			return null;

		return  appendDomChild(Attribute, null, "magnitude", value.toString());
	}

	public org.w3c.dom.Node addmagnitude(String value) throws Exception {
		return addmagnitude(new SchemaShort(value));
	}

	public void insertmagnitudeAt(SchemaShort value, int index) {
		insertDomChildAt(Attribute, null, "magnitude", index, value.toString());
	}

	public void insertmagnitudeAt(String value, int index) throws Exception {
		insertmagnitudeAt(new SchemaShort(value), index);
	}

	public void replacemagnitudeAt(SchemaShort value, int index) {
		replaceDomChildAt(Attribute, null, "magnitude", index, value.toString());
	}

	public void replacemagnitudeAt(String value, int index) throws Exception {
		replacemagnitudeAt(new SchemaShort(value), index);
	}
