/**
 * library_camerasType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class library_camerasType extends com.jmex.model.collada.xml.Node {
    ...
    public library_camerasType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "camera"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "camera", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getcameraCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "camera");
    }
    ...
    public cameraType newcamera() {
        return new cameraType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "camera"));
    }
    ...
    public org.w3c.dom.Node getAdvancedcameraCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "camera",
                curNode);
    ...
    public cameraType getcameraValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new cameraType(dereference(curNode));
    }
    ...
    public void removecameraAt(int index) {
        removeDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "camera", index);
    }
    ...
    public void addcamera(cameraType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "camera", value);
    }
