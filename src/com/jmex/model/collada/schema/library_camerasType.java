...
public class library_camerasType extends com.jmex.xml.xml.Node {

	public library_camerasType(library_camerasType node) {
		super(node);
	}

	public library_camerasType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_camerasType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_camerasType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "camera" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "camera", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new cameraType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_cameras");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getcameraMinCount() {
		return 1;
	}

	public static int getcameraMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getcameraCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "camera");
	}

	public boolean hascamera() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "camera");
	}

	public cameraType newcamera() {
		return new cameraType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "camera"));
	}

	public cameraType getcameraAt(int index) throws Exception {
		return new cameraType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "camera", index));
	}

	public org.w3c.dom.Node getStartingcameraCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "camera" );
	}

	public org.w3c.dom.Node getAdvancedcameraCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "camera", curNode );
	}

	public cameraType getcameraValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new cameraType(curNode);
	}

	public cameraType getcamera() throws Exception 
 {
		return getcameraAt(0);
	}

	public void removecameraAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "camera", index);
	}
	...
	public org.w3c.dom.Node addcamera(cameraType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "camera", value);
	}

	public void insertcameraAt(cameraType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "camera", index, value);
	}

	public void replacecameraAt(cameraType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "camera", index, value);
	}
