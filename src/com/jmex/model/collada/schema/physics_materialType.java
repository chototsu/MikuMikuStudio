/**
 * physics_materialType.java This file was generated by XMLSpy 2006sp2
...
public class physics_materialType extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public physics_materialType(physics_materialType node) {
        super(node);
    }

    public physics_materialType(org.w3c.dom.Node node) {
        super(node);
    }

    public physics_materialType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public physics_materialType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
            ...
            internalAdjustPrefix(tmpNode, true);
            new technique_commonType5(tmpNode).adjustPrefix();
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
    ...
    public technique_commonType5 newtechnique_common() {
        return new technique_commonType5(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "technique_common"));
    }

    public technique_commonType5 gettechnique_commonAt(int index)
            throws Exception {
        return new technique_commonType5(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
    ...
    public technique_commonType5 gettechnique_commonValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new technique_commonType5(dereference(curNode));
    }
    ...
    public void addtechnique_common(technique_commonType5 value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
