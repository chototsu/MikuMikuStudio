/**
 * int4.java This file was generated by XMLSpy 2006sp2 Enterprise Edition. YOU
...
public class int4 extends ListOfInts {
    ...
    public int4(String newValue) {
        super(newValue);
        validate();
    }

    public int4(SchemaString newValue) {
        super(newValue);
        validate();
    }
