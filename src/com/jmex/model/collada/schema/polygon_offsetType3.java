/**
 * polygon_offsetType3.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class polygon_offsetType3 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public polygon_offsetType3(polygon_offsetType3 node) {
        super(node);
    }

    public polygon_offsetType3(org.w3c.dom.Node node) {
        super(node);
    }

    public polygon_offsetType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public polygon_offsetType3(com.jmex.model.collada.xml.Document doc,
    ...
    public float22 getvalue2At(int index) throws Exception {
        return new float22(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public float22 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addvalue2(float22 value) {
