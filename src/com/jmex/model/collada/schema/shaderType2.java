...
public class shaderType2 extends com.jmex.xml.xml.Node {
	...
	public shaderType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public glsl_pipeline_stage getstageAt(int index) throws Exception {
		return new glsl_pipeline_stage(getDomNodeValue(getDomChildAt(Attribute, null, "stage", index)));
	}
	...
	public glsl_pipeline_stage getstageValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new glsl_pipeline_stage(getDomNodeValue(curNode));
	}
	...
	public glsl_pipeline_stage getstage() throws Exception 
 {
	...
	public org.w3c.dom.Node addstage(glsl_pipeline_stage value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addstage(String value) throws Exception {
		return addstage(new glsl_pipeline_stage(value));
	}
	...
	public fx_annotate_common getannotate() throws Exception 
 {
	...
	public compiler_targetType2 newcompiler_target() {
		return new compiler_targetType2(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "compiler_target"));
	}

	public compiler_targetType2 getcompiler_targetAt(int index) throws Exception {
		return new compiler_targetType2(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "compiler_target", index));
	}
