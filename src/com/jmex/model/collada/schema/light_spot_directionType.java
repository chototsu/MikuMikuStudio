/**
 * light_spot_directionType.java This file was generated by XMLSpy 2006sp2
...
public class light_spot_directionType extends
        com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public light_spot_directionType(light_spot_directionType node) {
        super(node);
    }

    public light_spot_directionType(org.w3c.dom.Node node) {
        super(node);
    }

    public light_spot_directionType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_spot_directionType(com.jmex.model.collada.xml.Document doc,
    ...
    public float3 getvalue2At(int index) throws Exception {
        return new float3(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public float3 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addvalue2(float3 value) {
