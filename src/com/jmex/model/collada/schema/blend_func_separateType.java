/**
 * blend_func_separateType.java This file was generated by XMLSpy 2006sp2
...
public class blend_func_separateType extends com.jmex.model.collada.xml.Node {
    ...
    public blend_func_separateType(com.jmex.model.collada.xml.Document doc,
    ...
    public src_rgbType newsrc_rgb() {
        return new src_rgbType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "src_rgb"));
    }

    public src_rgbType getsrc_rgbAt(int index) throws Exception {
        return new src_rgbType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "src_rgb",
                index)));
    }
    ...
    public src_rgbType getsrc_rgbValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new src_rgbType(dereference(curNode));
    }
    ...
    public void addsrc_rgb(src_rgbType value) {
    ...
    public dest_rgbType newdest_rgb() {
        return new dest_rgbType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "dest_rgb"));
    }

    public dest_rgbType getdest_rgbAt(int index) throws Exception {
        return new dest_rgbType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "dest_rgb",
                index)));
    }
    ...
    public dest_rgbType getdest_rgbValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new dest_rgbType(dereference(curNode));
    }
    ...
    public void adddest_rgb(dest_rgbType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "dest_rgb", value);
    }
    ...
    public src_alphaType newsrc_alpha() {
        return new src_alphaType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "src_alpha"));
    }

    public src_alphaType getsrc_alphaAt(int index) throws Exception {
        return new src_alphaType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "src_alpha",
                index)));
    }
    ...
    public src_alphaType getsrc_alphaValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new src_alphaType(dereference(curNode));
    }
    ...
    public void addsrc_alpha(src_alphaType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "src_alpha", value);
    }
    ...
    public dest_alphaType newdest_alpha() {
        return new dest_alphaType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "dest_alpha"));
    }

    public dest_alphaType getdest_alphaAt(int index) throws Exception {
        return new dest_alphaType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "dest_alpha",
                index)));
    }
    ...
    public dest_alphaType getdest_alphaValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new dest_alphaType(dereference(curNode));
    }
    ...
    public void adddest_alpha(dest_alphaType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "dest_alpha", value);
    }
