...
public class controllerType extends com.jmex.xml.xml.Node {

	public controllerType(controllerType node) {
		super(node);
	}

	public controllerType(org.w3c.dom.Node node) {
		super(node);
	}

	public controllerType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public controllerType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "skin" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "skin", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new skinType(tmpNode).adjustPrefix();
		}
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "morph" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "morph", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new morphType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "controller");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getskinMinCount() {
		return 1;
	}

	public static int getskinMaxCount() {
		return 1;
	}

	public int getskinCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "skin");
	}

	public boolean hasskin() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "skin");
	}

	public skinType newskin() {
		return new skinType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "skin"));
	}

	public skinType getskinAt(int index) throws Exception {
		return new skinType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "skin", index));
	}

	public org.w3c.dom.Node getStartingskinCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "skin" );
	}

	public org.w3c.dom.Node getAdvancedskinCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "skin", curNode );
	}

	public skinType getskinValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new skinType(curNode);
	}

	public skinType getskin() throws Exception 
 {
		return getskinAt(0);
	}

	public void removeskinAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "skin", index);
	}
	...
	public org.w3c.dom.Node addskin(skinType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "skin", value);
	}

	public void insertskinAt(skinType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "skin", index, value);
	}

	public void replaceskinAt(skinType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "skin", index, value);
	}

	public static int getmorphMinCount() {
		return 1;
	}

	public static int getmorphMaxCount() {
		return 1;
	}

	public int getmorphCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "morph");
	}

	public boolean hasmorph() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "morph");
	}

	public morphType newmorph() {
		return new morphType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "morph"));
	}

	public morphType getmorphAt(int index) throws Exception {
		return new morphType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "morph", index));
	}

	public org.w3c.dom.Node getStartingmorphCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "morph" );
	}

	public org.w3c.dom.Node getAdvancedmorphCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "morph", curNode );
	}

	public morphType getmorphValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new morphType(curNode);
	}

	public morphType getmorph() throws Exception 
 {
		return getmorphAt(0);
	}

	public void removemorphAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "morph", index);
	}
	...
	public org.w3c.dom.Node addmorph(morphType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "morph", value);
	}

	public void insertmorphAt(morphType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "morph", index, value);
	}

	public void replacemorphAt(morphType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "morph", index, value);
	}
