/**
 * controllerType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class controllerType extends com.jmex.model.collada.xml.Node {
    ...
    public controllerType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "skin"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "skin", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "morph"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "morph", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getskinCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "skin");
    }
    ...
    public skinType newskin() {
        return new skinType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "skin"));
    }

    public skinType getskinAt(int index) throws Exception {
        return new skinType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "skin", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedskinCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "skin", curNode);
    }

    public skinType getskinValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new skinType(dereference(curNode));
    }
    ...
    public void addskin(skinType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "skin", value);
    }
    ...
    public int getmorphCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "morph");
    }
    ...
    public morphType newmorph() {
        return new morphType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "morph"));
    }
    ...
    public org.w3c.dom.Node getAdvancedmorphCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "morph",
                curNode);
    ...
    public morphType getmorphValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new morphType(dereference(curNode));
    }
    ...
    public void removemorphAt(int index) {
        removeDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "morph", index);
    }
    ...
    public void addmorph(morphType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "morph", value);
    }
