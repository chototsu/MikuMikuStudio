/**
 * physics_modelType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class physics_modelType extends com.jmex.model.collada.xml.Node {
    ...
    public physics_modelType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "rigid_body"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "rigid_body", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                ...
                "rigid_constraint"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "rigid_constraint", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new rigid_constraintType(tmpNode).adjustPrefix();
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getrigid_bodyCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "rigid_body");
    }
    ...
    public rigid_bodyType newrigid_body() {
        return new rigid_bodyType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "rigid_body"));
    }

    public rigid_bodyType getrigid_bodyAt(int index) throws Exception {
        return new rigid_bodyType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "rigid_body",
                index)));
    }
    ...
    public rigid_bodyType getrigid_bodyValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new rigid_bodyType(dereference(curNode));
    }
    ...
    public void addrigid_body(rigid_bodyType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "rigid_body", value);
    }
    ...
    public rigid_constraintType newrigid_constraint() {
        return new rigid_constraintType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "rigid_constraint"));
    }

    public rigid_constraintType getrigid_constraintAt(int index)
            throws Exception {
        return new rigid_constraintType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "rigid_constraint", index)));
    }

    public org.w3c.dom.Node getStartingrigid_constraintCursor()
            throws Exception {
        return getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "rigid_constraint");
    ...
    public org.w3c.dom.Node getAdvancedrigid_constraintCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "rigid_constraint", curNode);
    }

    public rigid_constraintType getrigid_constraintValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new rigid_constraintType(dereference(curNode));
    }
    ...
    public void addrigid_constraint(rigid_constraintType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "rigid_constraint", value);
    }

    public void insertrigid_constraintAt(rigid_constraintType value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "rigid_constraint", index, value);
    }
    ...
    public instance_physics_modelType newinstance_physics_model() {
        return new instance_physics_modelType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "instance_physics_model"));
    }

    public instance_physics_modelType getinstance_physics_modelAt(int index)
            throws Exception {
        return new instance_physics_modelType(dereference(getDomChildAt(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model", index)));
    }

    public org.w3c.dom.Node getStartinginstance_physics_modelCursor()
            throws Exception {
        return getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model");
    ...
    public org.w3c.dom.Node getAdvancedinstance_physics_modelCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model", curNode);
    }

    public instance_physics_modelType getinstance_physics_modelValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new instance_physics_modelType(dereference(curNode));
    }

    public instance_physics_modelType getinstance_physics_model()
            throws Exception {
    ...
    public void addinstance_physics_model(instance_physics_modelType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model", value);
    }

    public void insertinstance_physics_modelAt(
            instance_physics_modelType value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model", index, value);
    }

    public void replaceinstance_physics_modelAt(
            instance_physics_modelType value, int index) {
        replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "instance_physics_model", index, value);
    }
