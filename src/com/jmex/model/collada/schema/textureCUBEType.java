...
public class textureCUBEType extends com.jmex.xml.xml.Node {
	...
	public textureCUBEType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "textureCUBE");
	}
	...
	public GL_MAX_TEXTURE_IMAGE_UNITS_index getindex() throws Exception 
 {
	...
	public gl_samplerCUBE newvalue2() {
		return new gl_samplerCUBE(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "value"));
	}

	public gl_samplerCUBE getvalue2At(int index) throws Exception {
		return new gl_samplerCUBE(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "value", index));
	}
	...
	public gl_samplerCUBE getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
	...
	public gl_samplerCUBE getvalue2() throws Exception 
 {
	...
	public org.w3c.dom.Node addvalue2(gl_samplerCUBE value) {
