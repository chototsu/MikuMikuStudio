/**
 * physics_sceneType.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class physics_sceneType extends com.jmex.model.collada.xml.Node {
    ...
    public physics_sceneType(com.jmex.model.collada.xml.Document doc,
    ...
    public technique_commonType6 newtechnique_common() {
        return new technique_commonType6(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "technique_common"));
    }

    public technique_commonType6 gettechnique_commonAt(int index)
            throws Exception {
        return new technique_commonType6(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
    ...
    public technique_commonType6 gettechnique_commonValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new technique_commonType6(dereference(curNode));
    }
    ...
    public void addtechnique_common(technique_commonType6 value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
