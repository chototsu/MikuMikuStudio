/**
 * clear_stencilType2.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class clear_stencilType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public clear_stencilType2(clear_stencilType2 node) {
        super(node);
    }

    public clear_stencilType2(org.w3c.dom.Node node) {
        super(node);
    }

    public clear_stencilType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public clear_stencilType2(com.jmex.model.collada.xml.Document doc,
    ...
    public int2 getvalue2At(int index) throws Exception {
        return new int2(getDomNodeValue(dereference(getDomChildAt(Attribute,
                null, "value", index))));
    }
    ...
    public int2 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
