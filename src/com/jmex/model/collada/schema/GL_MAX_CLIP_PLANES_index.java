/**
 * GL_MAX_CLIP_PLANES_index.java This file was generated by XMLSpy 2006sp2
...
public class GL_MAX_CLIP_PLANES_index extends SchemaInteger {

    private static final long serialVersionUID = 1L;

    public GL_MAX_CLIP_PLANES_index() {
        super();
    }

    public GL_MAX_CLIP_PLANES_index(String newValue) {
        super(newValue);
        validate();
    }

    public GL_MAX_CLIP_PLANES_index(SchemaInteger newValue) {
        super(newValue);
        validate();
    }
    ...
    public void validate() {
        ...
        if (compareTo(getMinInclusive()) < 0)
            throw new com.jmex.model.collada.xml.XmlException(
                    "Value of GL_MAX_CLIP_PLANES_index is out of range.");
    }
