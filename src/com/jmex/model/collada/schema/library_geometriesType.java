...
public class library_geometriesType extends com.jmex.xml.xml.Node {

	public library_geometriesType(library_geometriesType node) {
		super(node);
	}

	public library_geometriesType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_geometriesType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_geometriesType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_geometries");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getgeometryMinCount() {
		return 1;
	}

	public static int getgeometryMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getgeometryCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry");
	}

	public boolean hasgeometry() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry");
	}

	public geometryType newgeometry() {
		return new geometryType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "geometry"));
	}

	public geometryType getgeometryAt(int index) throws Exception {
		return new geometryType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry", index));
	}

	public org.w3c.dom.Node getStartinggeometryCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry" );
	}

	public org.w3c.dom.Node getAdvancedgeometryCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry", curNode );
	}

	public geometryType getgeometryValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new geometryType(curNode);
	}
	...
	public geometryType getgeometry() throws Exception 
 {
	...
	public void removegeometryAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "geometry", index);
	}
	...
	public org.w3c.dom.Node addgeometry(geometryType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "geometry", value);
	}

	public void insertgeometryAt(geometryType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "geometry", index, value);
	}

	public void replacegeometryAt(geometryType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "geometry", index, value);
	}
