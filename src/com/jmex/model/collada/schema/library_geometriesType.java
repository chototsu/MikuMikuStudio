/**
 * library_geometriesType.java This file was generated by XMLSpy 2006sp2
...
public class library_geometriesType extends com.jmex.model.collada.xml.Node {
    ...
    public library_geometriesType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "geometry"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "geometry", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public geometryType newgeometry() {
        return new geometryType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "geometry"));
    }

    public geometryType getgeometryAt(int index) throws Exception {
        return new geometryType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "geometry",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedgeometryCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "geometry",
                curNode);
    ...
    public geometryType getgeometryValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new geometryType(dereference(curNode));
    }
