...
public class model_view_matrixType2 extends com.jmex.xml.xml.Node {
	...
	public model_view_matrixType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "model_view_matrix");
	}
	...
	public float4x4 getvalue2At(int index) throws Exception {
		return new float4x4(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
	}
	...
	public float4x4 getvalue2ValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
	...
	public float4x4 getvalue2() throws Exception 
 {
	...
	public org.w3c.dom.Node addvalue2(float4x4 value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addvalue2(String value) throws Exception {
		return addvalue2(new float4x4(value));
	}
