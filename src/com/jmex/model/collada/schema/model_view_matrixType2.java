/**
 * model_view_matrixType2.java This file was generated by XMLSpy 2006sp2
...
public class model_view_matrixType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public model_view_matrixType2(model_view_matrixType2 node) {
        super(node);
    }

    public model_view_matrixType2(org.w3c.dom.Node node) {
        super(node);
    }

    public model_view_matrixType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public model_view_matrixType2(com.jmex.model.collada.xml.Document doc,
    ...
    public float4x4 newvalue2() {
        return new float4x4();
    }

    public float4x4 getvalue2At(int index) throws Exception {
        return new float4x4(getDomNodeValue(dereference(getDomChildAt(
    ...
    public float4x4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public float4x4 getvalue2() throws Exception {
    ...
    public void addvalue2(float4x4 value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new float4x4(value));
    }

    public void insertvalue2At(float4x4 value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new float4x4(value), index);
    }

    public void replacevalue2At(float4x4 value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new float4x4(value), index);
    }
