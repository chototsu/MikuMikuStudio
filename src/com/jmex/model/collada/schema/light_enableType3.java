/**
 * light_enableType3.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class light_enableType3 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public light_enableType3(light_enableType3 node) {
        super(node);
    }

    public light_enableType3(org.w3c.dom.Node node) {
        super(node);
    }

    public light_enableType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_enableType3(com.jmex.model.collada.xml.Document doc,
    ...
    public GL_MAX_LIGHTS_index newindex() {
        return new GL_MAX_LIGHTS_index();
    }

    public GL_MAX_LIGHTS_index getindexAt(int index) throws Exception {
        return new GL_MAX_LIGHTS_index(
    ...
    public GL_MAX_LIGHTS_index getindexValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public GL_MAX_LIGHTS_index getindex() throws Exception {
        return getindexAt(0);
    }
    ...
    public void addindex(GL_MAX_LIGHTS_index value) {
        if (value.isNull() == false) {
    ...
    public void addindex(String value) throws Exception {
        addindex(new GL_MAX_LIGHTS_index(value));
    }

    public void insertindexAt(GL_MAX_LIGHTS_index value, int index) {
    ...
    public void insertindexAt(String value, int index) throws Exception {
        insertindexAt(new GL_MAX_LIGHTS_index(value), index);
    }

    public void replaceindexAt(GL_MAX_LIGHTS_index value, int index) {
    ...
    public void replaceindexAt(String value, int index) throws Exception {
        replaceindexAt(new GL_MAX_LIGHTS_index(value), index);
    }
