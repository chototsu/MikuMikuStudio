/**
 * sourceType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class sourceType extends com.jmex.model.collada.xml.Node {
    ...
    public sourceType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "IDREF_array"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "IDREF_array", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "Name_array"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "Name_array", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "bool_array"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "bool_array", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "float_array"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "float_array", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "int_array"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "int_array", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getIDREF_arrayCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "IDREF_array");
    }
    ...
    public IDREF_arrayType newIDREF_array() {
        return new IDREF_arrayType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "IDREF_array"));
    }

    public IDREF_arrayType getIDREF_arrayAt(int index) throws Exception {
        return new IDREF_arrayType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "IDREF_array",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedIDREF_arrayCursor(
    ...
    public IDREF_arrayType getIDREF_arrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new IDREF_arrayType(dereference(curNode));
    }
    ...
    public void removeIDREF_array() {
        while (hasIDREF_array())
            removeIDREF_arrayAt(0);
    }

    public void addIDREF_array(IDREF_arrayType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "IDREF_array", value);
    }
    ...
    public int getName_arrayCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "Name_array");
    }
    ...
    public Name_arrayType newName_array() {
        return new Name_arrayType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "Name_array"));
    }

    public Name_arrayType getName_arrayAt(int index) throws Exception {
        return new Name_arrayType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "Name_array",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedName_arrayCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "Name_array",
                curNode);
    ...
    public Name_arrayType getName_arrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new Name_arrayType(dereference(curNode));
    }
    ...
    public void addName_array(Name_arrayType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "Name_array", value);
    }
    ...
    public int getbool_arrayCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "bool_array");
    }
    ...
    public bool_arrayType newbool_array() {
        return new bool_arrayType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "bool_array"));
    }

    public bool_arrayType getbool_arrayAt(int index) throws Exception {
        return new bool_arrayType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "bool_array",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedbool_arrayCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "bool_array",
                curNode);
    ...
    public bool_arrayType getbool_arrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new bool_arrayType(dereference(curNode));
    }
    ...
    public void addbool_array(bool_arrayType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "bool_array", value);
    }
    ...
    public float_arrayType newfloat_array() {
        return new float_arrayType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "float_array"));
    }

    public float_arrayType getfloat_arrayAt(int index) throws Exception {
        return new float_arrayType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "float_array",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedfloat_arrayCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "float_array",
                curNode);
    ...
    public float_arrayType getfloat_arrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new float_arrayType(dereference(curNode));
    }
    ...
    public void removefloat_array() {
        while (hasfloat_array())
            removefloat_arrayAt(0);
    }

    public void addfloat_array(float_arrayType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "float_array", value);
    }
    ...
    public int getint_arrayCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "int_array");
    }
    ...
    public int_arrayType newint_array() {
        return new int_arrayType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "int_array"));
    }

    public int_arrayType getint_arrayAt(int index) throws Exception {
        return new int_arrayType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "int_array",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedint_arrayCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "int_array",
                curNode);
    ...
    public int_arrayType getint_arrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new int_arrayType(dereference(curNode));
    }
    ...
    public void addint_array(int_arrayType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "int_array", value);
    }
    ...
    public technique_commonType9 newtechnique_common() {
        return new technique_commonType9(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "technique_common"));
    }

    public technique_commonType9 gettechnique_commonAt(int index)
            throws Exception {
        return new technique_commonType9(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
    ...
    public technique_commonType9 gettechnique_commonValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new technique_commonType9(dereference(curNode));
    }
    ...
    public void addtechnique_common(technique_commonType9 value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
