/**
 * glsl_setparam.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class glsl_setparam extends com.jmex.model.collada.xml.Node {
    ...
    public glsl_setparam(com.jmex.model.collada.xml.Document doc,
    ...
    public glsl_identifier getrefValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
    ...
    public void addref(glsl_identifier value) {
    ...
    public void addref(String value) throws Exception {
        addref(new glsl_identifier(value));
    }
    ...
    public glsl_setarray_type getarrayValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new glsl_setarray_type(dereference(curNode));
    }
    ...
    public void addarray(glsl_setarray_type value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "array", value);
    }
