...
public class glsl_setparam extends com.jmex.xml.xml.Node {
	...
	public glsl_setparam(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public gl_enumeration getenum() throws Exception 
 {
	...
	public glsl_setarray_type getarrayValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			...
			return new glsl_setarray_type(curNode);
	}
