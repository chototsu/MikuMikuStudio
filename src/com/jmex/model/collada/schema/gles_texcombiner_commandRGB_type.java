/**
 * gles_texcombiner_commandRGB_type.java
 *
...
public class gles_texcombiner_commandRGB_type extends com.jmex.xml.xml.Node {

	public gles_texcombiner_commandRGB_type(gles_texcombiner_commandRGB_type node) {
		super(node);
	}
	...
	public gles_texcombiner_commandRGB_type(org.w3c.dom.Document doc) {
		super(doc);
	}

	public gles_texcombiner_commandRGB_type(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "argument" );
			...
			new gles_texcombiner_argumentRGB_type(tmpNode).adjustPrefix();
		}
	}
	public void setXsiType() {
 		org.w3c.dom.Element el = (org.w3c.dom.Element) domNode;
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "gles_texcombiner_commandRGB_type");
	}
	...
	public gles_texcombiner_operatorRGB_enums getoperatorAt(int index) throws Exception {
		return new gles_texcombiner_operatorRGB_enums(getDomNodeValue(getDomChildAt(Attribute, null, "operator", index)));
	}
	...
	public gles_texcombiner_operatorRGB_enums getoperatorValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new gles_texcombiner_operatorRGB_enums(getDomNodeValue(curNode));
	}
	...
	public gles_texcombiner_operatorRGB_enums getoperator() throws Exception 
 {
	...
	public org.w3c.dom.Node addoperator(gles_texcombiner_operatorRGB_enums value) {
		if( value.isNull() )
			return null;
	...
	public org.w3c.dom.Node addoperator(String value) throws Exception {
		return addoperator(new gles_texcombiner_operatorRGB_enums(value));
	}

	public void insertoperatorAt(gles_texcombiner_operatorRGB_enums value, int index) {
	...
	public void insertoperatorAt(String value, int index) throws Exception {
		insertoperatorAt(new gles_texcombiner_operatorRGB_enums(value), index);
	}

	public void replaceoperatorAt(gles_texcombiner_operatorRGB_enums value, int index) {
	...
	public void replaceoperatorAt(String value, int index) throws Exception {
		replaceoperatorAt(new gles_texcombiner_operatorRGB_enums(value), index);
	}
	...
	public SchemaFloat getscale() throws Exception 
 {
	...
	public gles_texcombiner_argumentRGB_type newargument() {
		return new gles_texcombiner_argumentRGB_type(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "argument"));
	}

	public gles_texcombiner_argumentRGB_type getargumentAt(int index) throws Exception {
		return new gles_texcombiner_argumentRGB_type(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "argument", index));
	}
	...
	public gles_texcombiner_argumentRGB_type getargumentValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new gles_texcombiner_argumentRGB_type(curNode);
	}
	...
	public gles_texcombiner_argumentRGB_type getargument() throws Exception 
 {
	...
	public org.w3c.dom.Node addargument(gles_texcombiner_argumentRGB_type value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "argument", value);
	}

	public void insertargumentAt(gles_texcombiner_argumentRGB_type value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "argument", index, value);
	}

	public void replaceargumentAt(gles_texcombiner_argumentRGB_type value, int index) {
