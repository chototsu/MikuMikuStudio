/**
 * library_controllersType.java This file was generated by XMLSpy 2006sp2
...
public class library_controllersType extends com.jmex.model.collada.xml.Node {
    ...
    public library_controllersType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "controller"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "controller", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public int getcontrollerCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "controller");
    }
    ...
    public controllerType newcontroller() {
        return new controllerType(domNode.getOwnerDocument().createElementNS(
                "http://www.collada.org/2005/11/COLLADASchema", "controller"));
    }

    public controllerType getcontrollerAt(int index) throws Exception {
        return new controllerType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "controller",
                index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedcontrollerCursor(org.w3c.dom.Node curNode)
            throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "controller",
                curNode);
    ...
    public controllerType getcontrollerValueAtCursor(org.w3c.dom.Node curNode)
            throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new controllerType(dereference(curNode));
    }
    ...
    public void addcontroller(controllerType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "controller", value);
    }
