/**
 * library_physics_scenesType.java
 *
...
public class library_physics_scenesType extends com.jmex.xml.xml.Node {

	public library_physics_scenesType(library_physics_scenesType node) {
		super(node);
	}

	public library_physics_scenesType(org.w3c.dom.Node node) {
		super(node);
	}

	public library_physics_scenesType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public library_physics_scenesType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, true);
			new physics_sceneType(tmpNode).adjustPrefix();
		}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "library_physics_scenes");
	}
	...
	public assetType getasset() throws Exception 
 {
	...
	public static int getphysics_sceneMinCount() {
		return 1;
	}

	public static int getphysics_sceneMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getphysics_sceneCount() {
		return getDomChildCount(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene");
	}

	public boolean hasphysics_scene() {
		return hasDomChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene");
	}

	public physics_sceneType newphysics_scene() {
		return new physics_sceneType(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "physics_scene"));
	}

	public physics_sceneType getphysics_sceneAt(int index) throws Exception {
		return new physics_sceneType(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene", index));
	}

	public org.w3c.dom.Node getStartingphysics_sceneCursor() throws Exception {
		return getDomFirstChild(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene" );
	}

	public org.w3c.dom.Node getAdvancedphysics_sceneCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene", curNode );
	}

	public physics_sceneType getphysics_sceneValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new physics_sceneType(curNode);
	}

	public physics_sceneType getphysics_scene() throws Exception 
 {
		return getphysics_sceneAt(0);
	}

	public void removephysics_sceneAt(int index) {
		removeDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "physics_scene", index);
	}

	public void removephysics_scene() {
		while (hasphysics_scene())
			removephysics_sceneAt(0);
	}

	public org.w3c.dom.Node addphysics_scene(physics_sceneType value) {
		return appendDomElement("http://www.collada.org/2005/11/COLLADASchema", "physics_scene", value);
	}

	public void insertphysics_sceneAt(physics_sceneType value, int index) {
		insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "physics_scene", index, value);
	}

	public void replacephysics_sceneAt(physics_sceneType value, int index) {
		replaceDomElementAt("http://www.collada.org/2005/11/COLLADASchema", "physics_scene", index, value);
	}
