/**
 * library_physics_scenesType.java This file was generated by XMLSpy 2006sp2
...
public class library_physics_scenesType extends
    ...
    public library_physics_scenesType(
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "physics_scene"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "physics_scene", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
    ...
    public physics_sceneType newphysics_scene() {
        return new physics_sceneType(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "physics_scene"));
    }
    ...
    public physics_sceneType getphysics_sceneAt(int index) throws Exception {
        return new physics_sceneType(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "physics_scene", index)));
    }
    ...
    public org.w3c.dom.Node getAdvancedphysics_sceneCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "physics_scene", curNode);
    }

    public physics_sceneType getphysics_sceneValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
            return new physics_sceneType(dereference(curNode));
    }
    ...
    public void addphysics_scene(physics_sceneType value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "physics_scene", value);
    }
