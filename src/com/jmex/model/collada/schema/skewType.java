...
public class skewType extends com.jmex.xml.xml.Node {

	public skewType(skewType node) {
		super(node);
	}

	public skewType(org.w3c.dom.Node node) {
		super(node);
	}

	public skewType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public skewType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
		super(doc, namespaceURI, prefix, name);
	}
	

	public float7 getValue() {
		return new float7(getDomNodeValue(domNode));
	}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "skew");
	}
