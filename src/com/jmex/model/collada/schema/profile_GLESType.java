...
public class profile_GLESType extends com.jmex.xml.xml.Node {
	...
	public profile_GLESType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "profile_GLES");
	}
	...
	public gles_newparam getnewparam() throws Exception 
 {
	...
	public techniqueType3 newtechnique() {
		return new techniqueType3(domNode.getOwnerDocument().createElementNS("http://www.collada.org/2005/11/COLLADASchema", "technique"));
	}

	public techniqueType3 gettechniqueAt(int index) throws Exception {
		return new techniqueType3(getDomChildAt(Element, "http://www.collada.org/2005/11/COLLADASchema", "technique", index));
	}
	...
	public techniqueType3 gettechniqueValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.jmex.xml.xml.XmlException("Out of range");
		else
			return new techniqueType3(curNode);
	}
	...
	public techniqueType3 gettechnique() throws Exception 
 {
	...
	public org.w3c.dom.Node addtechnique(techniqueType3 value) {
