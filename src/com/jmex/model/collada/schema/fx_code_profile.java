...
public class fx_code_profile extends com.jmex.xml.xml.Node {

	public fx_code_profile(fx_code_profile node) {
		super(node);
	}

	public fx_code_profile(org.w3c.dom.Node node) {
		super(node);
	}

	public fx_code_profile(org.w3c.dom.Document doc) {
		super(doc);
	}

	public fx_code_profile(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "fx_code_profile");
	}
