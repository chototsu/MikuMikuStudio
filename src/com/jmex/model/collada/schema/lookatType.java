...
public class lookatType extends com.jmex.xml.xml.Node {

	public lookatType(lookatType node) {
		super(node);
	}

	public lookatType(org.w3c.dom.Node node) {
		super(node);
	}

	public lookatType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public lookatType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
		super(doc, namespaceURI, prefix, name);
	}
	

	public float3x3 getValue() {
		return new float3x3(getDomNodeValue(domNode));
	}
	...
	public void setXsiType() {
		...
		el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "lookat");
	}
