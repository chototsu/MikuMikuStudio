/**
 * spotType.java This file was generated by XMLSpy 2006sp2 Enterprise Edition.
...
public class spotType extends com.jmex.model.collada.xml.Node {
    ...
    public spotType(com.jmex.model.collada.xml.Document doc,
    ...
    public void adjustPrefix() {
        ...
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "falloff_angle"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_angle", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new TargetableFloat(tmpNode).adjustPrefix();
        }
        for (org.w3c.dom.Node tmpNode = getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent"); tmpNode != null; tmpNode = getDomNextChild(
                Element, "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent", tmpNode)) {
            internalAdjustPrefix(tmpNode, true);
            new TargetableFloat(tmpNode).adjustPrefix();
        }
    }
    ...
    public int getfalloff_angleCount() {
        return getDomChildCount(Element,
                "http://www.collada.org/2005/11/COLLADASchema", "falloff_angle");
    }
    ...
    public TargetableFloat newfalloff_angle() {
        return new TargetableFloat(domNode.getOwnerDocument()
                .createElementNS(
                        "http://www.collada.org/2005/11/COLLADASchema",
                        "falloff_angle"));
    }
    ...
    public org.w3c.dom.Node getAdvancedfalloff_angleCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_angle", curNode);
    }

    public TargetableFloat getfalloff_angleValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void removefalloff_angle() {
        while (hasfalloff_angle())
            removefalloff_angleAt(0);
    }

    public void addfalloff_angle(TargetableFloat value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "falloff_angle", value);
    }
    ...
    public TargetableFloat getfalloff_exponentAt(int index) throws Exception {
        return new TargetableFloat(dereference(getDomChildAt(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent", index)));
    }

    public org.w3c.dom.Node getStartingfalloff_exponentCursor()
            throws Exception {
        return getDomFirstChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent");
    ...
    public org.w3c.dom.Node getAdvancedfalloff_exponentCursor(
            org.w3c.dom.Node curNode) throws Exception {
        return getDomNextChild(Element,
                "http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent", curNode);
    }

    public TargetableFloat getfalloff_exponentValueAtCursor(
            org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null)
            throw new com.jmex.model.collada.xml.XmlException("Out of range");
        else
    ...
    public void removefalloff_exponent() {
        while (hasfalloff_exponent())
            removefalloff_exponentAt(0);
    }

    public void addfalloff_exponent(TargetableFloat value) {
        appendDomElement("http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent", value);
    }

    public void insertfalloff_exponentAt(TargetableFloat value, int index) {
        insertDomElementAt("http://www.collada.org/2005/11/COLLADASchema",
                "falloff_exponent", index, value);
    }
