/**
 * gl_material_type.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public class gl_material_type extends SchemaString {
    ...
    public static String[] sEnumValues = { "EMISSION", "AMBIENT", "DIFFUSE",
    ...
    public void validate() {
        ...
        if (!isValidEnumerationValue(toString()))
            throw new com.jmex.model.collada.xml.XmlException(
                    "Value of gl_material_type is invalid.");
    }
}
