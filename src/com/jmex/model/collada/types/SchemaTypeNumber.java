/**
 * SchemaTypeNumber.java This file was generated by XMLSpy 2006sp2 Enterprise
...
public interface SchemaTypeNumber extends SchemaType {
    ...
    // short, byte are not considered because Java treats everything as int and
    // numbers are casted only at the end.
    // unsigned types are not considered, because these simple-types are not
    // supported by Java
    ...
    public int numericType(); // returns if the value is nummeric and up to
                                // which degree.
