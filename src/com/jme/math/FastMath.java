...
public class FastMath {
    ...
    /** */
    public static float fastSin0 (float fAngle)
    {
    ...
    /** */
    public static float fastSin1 (float fAngle)
    {
        float fASqr = fAngle*fAngle;
    ...
    /** */
    public static float fastCos0 (float fAngle)
    {
        float fASqr = fAngle*fAngle;
    ...
    /** */
    public static float fastCos1 (float fAngle)
    {
        float fASqr = fAngle*fAngle;
    ...
    /** */
    public static float fastTan0 (float fAngle)
    {
        float fASqr = fAngle*fAngle;
    ...
    /** */
    public static float fastTan1 (float fAngle)
    {
        float fASqr = fAngle*fAngle;
    ...
    /** */
    public static float fastInvSin (float fValue)
    {
    ...
    /** */
    public static float fastInvCos (float fValue)
    {
        float fRoot = sqrt((1.0f)-fValue);
        float fResult = -0.0187293f;
        fResult *= fValue;
    ...
    /** */
    public static float fastInvTan0 (float fValue)
    {
    ...
    /** */
    public static float fastInvTan1 (float fValue)
    {
        float fVSqr = fValue*fValue;
...
//
//    /** */
//    public static float fastInvSqrt (float fValue)
//    {
